    ...
    async fn(t) {
      ...
      if (x = [...x, {
        ...
        switch (p) {
          case "bestFit": {
            var E;
            const ne = (E = x.slice().sort((ie, J) => ie.overflows.filter((de) => de > 0).reduce((de, be) => de + be, 0) - J.overflows.filter((de) => de > 0).reduce((de, be) => de + be, 0))[0]) == null ? void 0 : E.placement;
            ne && (X = ne);
            break;
          }
...
var El = Object.defineProperty, Cl = Object.defineProperties, jl = Object.getOwnPropertyDescriptors, no = Object.getOwnPropertySymbols, Tl = Object.prototype.hasOwnProperty, Il = Object.prototype.propertyIsEnumerable, ro = (e, t, n) => t in e ? El(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, Ne = (e, t) => {
  for (var n in t || (t = {}))
  ...
  methods: {
    ...
    async $_computePosition() {
      ...
      Object.assign(this.result, {
        ...
        strategy: r.strategy,
        arrow: Ne(Ne({}, r.middlewareData.arrow), r.middlewareData.arrowOverflow)
      });
    },
...
function ec(e, t, n, r, o, i) {
  const s = ve("PopperContent"), a = ve("Popper");
  return g(), se(a, {
    ref: "popper",
    theme: e.finalTheme,
...
function dc() {
  ...
  Vt = z([]), Zn = Fa({
    ...
    render() {
      return this.directives.map((t) => yn(lc, Yt(Ne({}, t.options), {
...
function kc(e, t) {
  let n = z(vo(e.value.type, e.value.as));
  return Fe(() => {
...
function Pc(e, t, n) {
  let r = z(n == null ? void 0 : n.value), o = M(() => e.value !== void 0);
...
function Cc({ slot: e = z({}), name: t = "Description", props: n = {} } = {}) {
  let r = z([]);
  function o(i) {
...
let av = N({ name: "Description", props: { as: { type: [Object, String], default: "p" } }, setup(e, { attrs: t, slots: n }) {
  let r = Ec(), o = `headlessui-description-${Br()}`;
  return Fe(() => Qi(r.register(o))), () => {
    let { name: i = "Description", slot: s = z({}), props: a = {} } = r, l = e, u = { ...Object.entries(a).reduce((c, [p, f]) => Object.assign(c, { [p]: $(f) }), {}), id: o };
...
let lv = N({ name: "Label", props: { as: { type: [Object, String], default: "label" }, passive: { type: [Boolean], default: !1 } }, setup(e, { slots: t, attrs: n }) {
...
N({ name: "SwitchGroup", props: { as: { type: [Object, String], default: "template" } }, setup(e, { slots: t, attrs: n }) {
  let r = z(null), o = jc({ name: "SwitchLabel", props: { onClick() {
...
let Tc = N({ name: "Switch", emits: { "update:modelValue": (e) => !0 }, props: { as: { type: [Object, String], default: "button" }, modelValue: { type: Boolean, default: void 0 }, defaultChecked: { type: Boolean, default: !1 }, name: { type: String, optional: !0 }, value: { type: String, optional: !0 } }, inheritAttrs: !1, setup(e, { emit: t, attrs: n, slots: r, expose: o }) {
  ...
  let c = z(null), p = i === null ? c : i.switchRef, f = kc(M(() => ({ as: e.as, type: n.type })), p);
  o({ el: p, $el: p });
  function d(b) {
    b.preventDefault(), u();
  }
...
function Rc(e) {
  return typeof e == "function" ? M(e) : z(e);
}
function Is(e, t = !0) {
  Yi() ? Fe(e) : t ? e() : Dr(e);
}
...
function cu(e = {}) {
  const {
    ...
    light: "light",
    dark: "dark"
  }, e.modes || {}), p = Rs({ window: o }), f = M(() => p.value ? "dark" : "light"), d = l || (s == null ? z(r) : Ms(s, r, i, { window: o, listenToStorageChanges: a })), v = M({
    get() {
...
function ku({ window: e = Ze } = {}) {
  ...
  const t = z(e.pageXOffset), n = z(e.pageYOffset);
  return Ds("scroll", () => {
...
const ft = _u(), Su = /* @__PURE__ */ h("span", { class: "sr-only" }, "Toggle Dark Mode", -1), $u = /* @__PURE__ */ h("svg", {
  ...
  setup(e) {
    return (t, n) => {
      const r = ve("ClientOnly");
      return g(), se(r, null, {
        default: ye(() => [
          B($(Tc), {
            modelValue: $(ft),
            "onUpdate:modelValue": n[0] || (n[0] = (o) => Zi(ft) ? ft.value = o : null),
            class: Q([
...
function Tu() {
  var n;
  const e = gu(jo, ""), t = z((n = e.value) != null ? n : void 0);
  return He(t, () => {
...
}), zs = /#.*$/, Du = /(index)?\.(md|html)$/, Lu = typeof window < "u", Mu = z(Lu ? location.hash : "");
function kt(e, t, n = !1) {
  if (t === void 0)
    return !1;
  if (e = To(`/${e}`), n)
...
const Hu = ["label"], Bu = ["value", "label", "selected"], zu = /* @__PURE__ */ N({
  ...
  setup(e) {
    ...
    return (r, o) => {
      const i = ve("MobileNavigationItem", !0);
      return g(), w(R, null, [
...
const pn = /* @__PURE__ */ St(ud, [["render", hd]]), md = {
  ...
  setup(e) {
    const t = e, n = {
      ...
      cube: cd,
      chevron_right: pn
    }, { page: r, site: o } = Ee(), i = t.item.text, s = p(o.value.base, t.item.link), a = t.item.items, l = M(() => kt(r.value.relativePath, t.item.link)), u = t.item.icon && n[t.item.icon], c = z(!!t.item.hideChildren);
    function p(f, d) {
      return d === void 0 || d.startsWith("#") ? d : Ru(f, d);
    }
    return (f, d) => {
      var _, b, y;
      const v = ve("SideBarLink", !0);
...
function Cn() {
  for (var e; Cn.__r = Ht.length; )
    e = Ht.sort(function(t, n) {
      ...
      var n, r, o, i, s, a;
      t.__d && (s = (i = (n = t).__v).__e, (a = n.__P) && (r = [], (o = De({}, i)).__v = i.__v + 1, Fr(a, i, o, n.__n, a.ownerSVGElement !== void 0, i.__h != null ? [s] : null, r, s == null ? Ut(i) : s, i.__h), Qs(r, i), i.__e != s && Ws(i)));
    });
}
  ...
  try {
    e:
      if (typeof x == "function") {
        if (b = t.props, y = (u = x.contextType) && r[u.__c], S = u ? y ? y.props.value : u.__ : r, n.__c ? _ = (c = t.__c = n.__c).__ = c.__E : ("prototype" in x && x.prototype.render ? t.__c = c = new x(b, S) : (t.__c = c = new Ie(b, S), c.constructor = x, c.render = Of), y && y.sub(c), c.props = b, c.state || (c.state = {}), c.context = S, c.__n = r, p = c.__d = !0, c.__h = []), c.__s == null && (c.__s = c.state), x.getDerivedStateFromProps != null && (c.__s == c.state && (c.__s = De({}, c.__s)), De(c.__s, x.getDerivedStateFromProps(b, c.__s))), f = c.props, d = c.state, p)
...
function kf(e, t, n) {
  var r, o, i, s = arguments, a = De({}, e.props);
  for (i in t)
    i == "key" ? r = t[i] : i == "ref" ? o = t[i] : a[i] = t[i];
  if (arguments.length > 3)
    for (n = [n], i = 3; i < arguments.length; i++)
...
T = { __e: function(e, t) {
  ...
  throw e;
}, __v: 0 }, Ie.prototype.setState = function(e, t) {
  var n;
  n = this.__s != null && this.__s !== this.state ? this.__s : this.__s = De({}, this.state), typeof e == "function" && (e = e(De({}, n), this.props)), e && De(n, e), e != null && this.__v && (t && this.__h.push(t), br(this));
}, Ie.prototype.forceUpdate = function(e) {
  this.__v && (this.__e = !0, e && this.__h.push(e), br(this));
}, Ie.prototype.render = Xe, Ht = [], Fs = typeof Promise == "function" ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, Cn.__r = 0, Us = 0;
...
(kr.prototype = new Ie()).isPureReactComponent = !0, kr.prototype.shouldComponentUpdate = function(e, t) {
...
T.__e = function(e, t, n) {
  ...
  Ef(e, t, n);
}, (mn.prototype = new Ie()).__c = function(e, t) {
  var n = t.__c, r = this;
...
(At.prototype = new Ie()).__e = function(e) {
...
}, Component: Ie, PureComponent: kr, memo: function(e, t) {
  function n(o) {
        ...
        if (y.key === "ArrowUp" || y.key === "ArrowDown") {
          var L = function() {
            ...
            if (x.getState().activeItemId !== null && J) {
              var de = J.item, be = J.itemInputValue, rt = J.itemUrl, qe = J.source;
              qe.onActive(lt({ event: y, item: de, itemInputValue: be, itemUrl: rt, refresh: k, source: qe, state: x.getState() }, P));
            }
          };
...
var xp = function(e, t) {
  switch (t.type) {
    ...
    case "mousemove":
      return V(V({}, e), {}, { activeItemId: t.payload });
    case "setQuery":
      return V(V({}, e), {}, { query: t.payload, completion: null });
    case "setCollections":
      return V(V({}, e), {}, { collections: t.payload });
    case "setIsOpen":
      return V(V({}, e), {}, { isOpen: t.payload });
    case "setStatus":
      return V(V({}, e), {}, { status: t.payload });
    case "setContext":
      return V(V({}, e), {}, { context: V(V({}, e.context), t.payload) });
    case "ArrowDown":
      var n = V(V({}, e), {}, { activeItemId: t.payload.hasOwnProperty("nextActiveItemId") ? t.payload.nextActiveItemId : ii(1, e.activeItemId, Pr(e), t.props.defaultActiveItemId) });
      return V(V({}, n), {}, { completion: bi({ state: n }) });
    case "ArrowUp":
      var r = V(V({}, e), {}, { activeItemId: ii(-1, e.activeItemId, Pr(e), t.props.defaultActiveItemId) });
      return V(V({}, r), {}, { completion: bi({ state: r }) });
    case "Escape":
      return e.isOpen ? V(V({}, e), {}, { activeItemId: null, isOpen: !1, completion: null }) : V(V({}, e), {}, { activeItemId: null, query: "", status: "idle", collections: [] });
    case "submit":
      return V(V({}, e), {}, { activeItemId: null, isOpen: !1, status: "idle" });
    case "reset":
      return V(V({}, e), {}, { activeItemId: t.props.openOnFocus === !0 ? t.props.defaultActiveItemId : null, status: "idle", query: "" });
    case "focus":
      return V(V({}, e), {}, { activeItemId: t.props.defaultActiveItemId, isOpen: (t.props.openOnFocus || Boolean(e.query)) && t.props.shouldPanelOpen({ state: e }) });
    case "blur":
      return t.props.debug ? e : V(V({}, e), {}, { isOpen: !1, activeItemId: null });
    case "mouseleave":
      return V(V({}, e), {}, { activeItemId: t.props.defaultActiveItemId });
    default:
...
function kh(e) {
  var t = e.appId, n = e.apiKey, r = e.indexName, o = e.placeholder, i = o === void 0 ? "Search docs" : o, s = e.searchParameters, a = e.onClose, l = a === void 0 ? Wp : a, u = e.transformItems, c = u === void 0 ? ji : u, p = e.hitComponent, f = p === void 0 ? Pp : p, d = e.resultsFooterComponent, v = d === void 0 ? function() {
    ...
    return kp({ id: "docsearch", defaultActiveItemId: 0, placeholder: i, openOnFocus: !0, initialState: { query: H, context: { searchSuggestions: [] } }, navigator: _, onStateChange: function(D) {
      ...
      var q = D.query, oe = D.state, ae = D.setContext, we = D.setStatus;
      return q ? re.search([{ query: q, indexName: r, params: ar({ attributesToRetrieve: ["hierarchy.lvl0", "hierarchy.lvl1", "hierarchy.lvl2", "hierarchy.lvl3", "hierarchy.lvl4", "hierarchy.lvl5", "hierarchy.lvl6", "content", "type", "url"], attributesToSnippet: ["hierarchy.lvl1:".concat(O.current), "hierarchy.lvl2:".concat(O.current), "hierarchy.lvl3:".concat(O.current), "hierarchy.lvl4:".concat(O.current), "hierarchy.lvl5:".concat(O.current), "hierarchy.lvl6:".concat(O.current), "content:".concat(O.current)], snippetEllipsisText: "\u2026", highlightPreTag: "<mark>", highlightPostTag: "</mark>", hitsPerPage: 20 }, s) }]).catch(function(ee) {
        throw ee.name === "RetryError" && we("error"), ee;
      }).then(function(ee) {
        var le = ee.results[0], fe = le.hits, Ae = le.nbHits, it = Ci(fe, function(st) {
          return ma(st);
        });
        return oe.context.searchSuggestions.length < Object.keys(it).length && ae({ searchSuggestions: Object.keys(it) }), ae({ nbHits: Ae }), Object.values(it).map(function(st, Pt) {
  ...
  }, [r, s, re, l, Z, Y, Oe, H, i, _, c, P]), ge = _e.getEnvironmentProps, ce = _e.getRootProps, Ke = _e.refresh;
  return function(D) {
    var q = D.getEnvironmentProps, oe = D.panelElement, ae = D.formElement, we = D.inputElement;
    m.useEffect(function() {
      if (oe && ae && we) {
        var ee = q({ panelElement: oe, formElement: ae, inputElement: we }), le = ee.onTouchStart, fe = ee.onTouchMove;
  ...
  }({ getEnvironmentProps: ge, panelElement: ot.current, formElement: We.current, inputElement: I.current }), function(D) {
    var q = D.container;
    m.useEffect(function() {
      if (q) {
        var oe = q.querySelectorAll("a[href]:not([disabled]), button:not([disabled]), input:not([disabled])"), ae = oe[0], we = oe[oe.length - 1];
        return q.addEventListener("keydown", ee), function() {
          q.removeEventListener("keydown", ee);
        };
      }
      function ee(le) {
        le.key === "Tab" && (le.shiftKey ? document.activeElement === ae && (le.preventDefault(), we.focus()) : document.activeElement === we && (le.preventDefault(), ae.focus()));
      }
    }, [q]);
  ...
  }, []), m.createElement("div", zt({ ref: qe }, ce({ "aria-expanded": !0 }), { className: ["DocSearch", "DocSearch-Container", be.status === "stalled" && "DocSearch-Container--Stalled", be.status === "error" && "DocSearch-Container--Errored"].filter(Boolean).join(" "), role: "button", tabIndex: 0, onMouseDown: function(D) {
    D.target === D.currentTarget && l();
  } }), m.createElement("div", { className: "DocSearch-Modal", ref: Ce }, m.createElement("header", { className: "DocSearch-SearchBar", ref: We }, m.createElement(rh, zt({}, _e, { state: be, autoFocus: H.length === 0, inputRef: I, isFromSelection: Boolean(H) && H === j, translations: ie, onClose: l }))), m.createElement("div", { className: "DocSearch-Dropdown", ref: ot }, m.createElement(eh, zt({}, _e, { indexName: r, state: be, hitComponent: f, resultsFooterComponent: v, disableUserPersonalization: P, recentSearches: Z, favoriteSearches: Y, inputRef: I, translations: J, getMissingResultsUrl: X, onItemClick: function(D) {
    Oe(D), l();
...
const Ch = /* @__PURE__ */ h("svg", {
...
], -1), jh = { class: "hidden lg:block" }, Th = /* @__PURE__ */ h("span", { class: "ml-2" }, "Search", -1), Ih = { class: "sr-only" }, Ah = {
      ...
      return g(), w(R, null, [
        ...
        h("div", {
          ...
          h("div", jh, [
            ...
            B(l, null, {
              default: ye(() => [
                h("span", Ih, "Press " + F($(r)) + "+K to open quick search", 1),
                h("span", Ah, F($(n)) + "K", 1)
              ]),
              _: 1
            })
...
], -1), Dh = { class: "nav-bar top-0 z-10 lg:sticky" }, Lh = { class: "bg-ns-blue py-4 backdrop-blur dark:bg-slate-900 dark:[@supports(backdrop-filter:blur(0))]:bg-slate-900/80" }, Mh = {
  class: "relative mx-auto flex items-center justify-between px-4 sm:px-6 2xl:container",
  "aria-label": "Global"
}, Rh = { class: "flex flex-1 items-center" }, Hh = { class: "flex w-full items-center justify-between lg:w-auto" }, Bh = ["href"], zh = /* @__PURE__ */ h("span", { class: "sr-only" }, "NativeScript", -1), Vh = { class: "flex items-center space-x-4 lg:hidden" }, Fh = { class: "-mr-1 flex items-center" }, Uh = ["aria-expanded"], qh = /* @__PURE__ */ h("span", { class: "sr-only" }, "Open main menu", -1), Wh = /* @__PURE__ */ h("svg", {
  class: "h-6 w-6",
  xmlns: "http://www.w3.org/2000/svg",
  fill: "none",
  viewBox: "0 0 24 24",
  ...
  qh,
  Wh
], Jh = { class: "ml-10 hidden space-x-8 lg:flex" }, Gh = { class: "flex flex-1 justify-center px-2 lg:justify-end" }, Qh = { class: "w-full max-w-xl xl:max-w-xs" }, Yh = { class: "hidden lg:flex lg:items-center lg:space-x-6" }, Zh = ["href", "target"], Xh = { class: "relative" }, e0 = ["aria-expanded"], t0 = /* @__PURE__ */ h("span", { class: "sr-only" }, "Open additional menu", -1), n0 = /* @__PURE__ */ h("svg", {
  class: "h-6 w-6",
  role: "presentation",
  xmlns: "http://www.w3.org/2000/svg",
  fill: "none",
...
}, i0 = { class: "overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 dark:shadow-none dark:ring-slate-300/10" }, s0 = { class: "relative grid gap-6 bg-white px-5 py-6 dark:bg-slate-800 sm:gap-8 sm:p-8" }, a0 = ["href", "target"], l0 = { class: "text-base font-medium text-gray-900 dark:text-slate-200" }, c0 = { class: "mt-1 text-sm text-gray-500 dark:text-slate-400" }, u0 = /* @__PURE__ */ h("a", {
...
}, f0 = { class: "overflow-hidden rounded-lg bg-white shadow-md ring-1 ring-black ring-opacity-5" }, p0 = { class: "flex items-center justify-between px-5 pt-4" }, h0 = { class: "-mr-3" }, m0 = /* @__PURE__ */ h("span", { class: "sr-only" }, "Close menu", -1), v0 = /* @__PURE__ */ h("svg", {
  class: "h-6 w-6",
  xmlns: "http://www.w3.org/2000/svg",
  fill: "none",
  viewBox: "0 0 24 24",
  ...
  m0,
  v0
], g0 = { class: "pt-5 pb-6" }, y0 = { class: "space-y-1 px-2" }, b0 = ["href", "target"], w0 = /* @__PURE__ */ h("hr", { class: "-mx-2" }, null, -1), x0 = ["href", "target"], O0 = /* @__PURE__ */ N({
  __name: "Header",
  props: {
    nav: {
      type: Array,
...
function E0(e, t) {
  return g(), w("svg", S0, P0);
}
const C0 = /* @__PURE__ */ St(k0, [["render", E0]]), j0 = {
  class: "flex",
...
}, A0 = /* @__PURE__ */ h("span", { class: "sr-only" }, "Home", -1), N0 = { class: "flex items-center" }, D0 = /* @__PURE__ */ N({
  __name: "Breadcrumbs",
  setup(e) {
...
}), L0 = /* @__PURE__ */ h("h4", { class: "text-sm font-bold text-gray-900 dark:text-white" }, " Contributors ", -1), M0 = { class: "mt-2 flex -space-x-1 overflow-hidden" }, R0 = ["href"], H0 = ["src", "alt"], B0 = /* @__PURE__ */ N({
...
}), z0 = { class: "text-xs text-slate-500" }, V0 = ["datatime"], F0 = /* @__PURE__ */ N({
  ...
  setup(e) {
    ...
    return Fe(() => {
      ...
      var l;
      return wt((g(), w("p", z0, [
        Te(F((l = $(t).lastUpdatedText) != null ? l : "Last updated") + ": ", 1),
        h("time", { datatime: $(o) }, F(i.value), 9, V0)
      ], 512)), [
        [bn, i.value]
      ]);
    };
  ...
  (function(n, r) {
    ...
    var k = function(O, j, H, re) {
      ...
      for (var Y = c ? new Float32Array(l) : new Array(l), Z = 0; Z < l; ++Z)
        Y[Z] = v(Z * u, O, H);
      function Oe(_e) {
        for (var ge = 0, ce = 1, Ke = l - 1; ce !== Ke && Y[ce] <= _e; ++ce)
          ge += u;
        --ce;
        var D = (_e - Y[ce]) / (Y[ce + 1] - Y[ce]), q = ge + D * u, oe = _(q, O, H);
        return oe >= i ? y(_e, q, O, H) : oe === 0 ? q : b(_e, ge, ge + u, O, H);
      }
      return function(ge) {
        return ge === 0 ? 0 : ge === 1 ? 1 : v(Oe(ge), j, re);
      };
    }, x = {
    ...
    var ne = function() {
      var O, j, H, re, Y, Z, Oe, _e, ge, ce, Ke, D, q, oe, ae, we, ee, le, fe, Ae, it, st, Pt, ke = function(ue) {
        !_e || (Pt = ue, Ae = !0);
      }, Je, Se, Kn, Et;
      function Ta(pe) {
        var ue = pe.scrollTop;
      ...
      function qr() {
        it = E.cumulativeOffset(j), st = E.cumulativeOffset(O), D && (ae = st.left - it.left + Z, le = ae - oe), q && (ee = st.top - it.top + Z, fe = ee - we);
      }
      function Wr(pe) {
        if (Ae)
          return Kr();
        Se || (Se = pe), Y || qr(), Kn = pe - Se, Et = Math.min(Kn / H, 1), Et = Je(Et), Jr(j, we + fe * Et, oe + le * Et), Kn < H ? window.requestAnimationFrame(Wr) : Kr();
      }
      function Kr() {
        Ae || Jr(j, ee, ae), Se = !1, E.off(j, A, ke), Ae && Ke && Ke(Pt, O), !Ae && ce && ce(O);
      }
      ...
      function Aa(pe, ue) {
        ...
        if (j = E.$(te.container || C.container), H = te.hasOwnProperty("duration") ? te.duration : C.duration, Y = te.hasOwnProperty("lazy") ? te.lazy : C.lazy, re = te.easing || C.easing, Z = te.hasOwnProperty("offset") ? te.offset : C.offset, Oe = te.hasOwnProperty("force") ? te.force !== !1 : C.force, _e = te.hasOwnProperty("cancelable") ? te.cancelable !== !1 : C.cancelable, ge = te.onStart || C.onStart, ce = te.onDone || C.onDone, Ke = te.onCancel || C.onCancel, D = te.x === void 0 ? C.x : te.x, q = te.y === void 0 ? C.y : te.y, typeof Z == "function" && (Z = Z(O, j)), oe = Ia(j), we = Ta(j), qr(), Ae = !1, !Oe) {
          var Na = j.tagName.toLowerCase() === "body" ? document.documentElement.clientHeight || window.innerHeight : j.offsetHeight, Gr = we, Da = Gr + Na, Qr = ee - Z, La = Qr + O.offsetHeight;
          if (Qr >= Gr && La <= Da) {
            ce && ce(O);
            return;
          }
...
const Pa = $a.exports, U0 = /* @__PURE__ */ h("div", { class: "text-sm font-semibold leading-6 text-gray-900 dark:text-white" }, " On this page ", -1), q0 = { class: "mt-4 text-sm leading-6 text-slate-700 dark:text-slate-400" }, W0 = ["onClick"], K0 = ["href"], J0 = { key: 0 }, G0 = { class: "" }, Q0 = ["href"], Y0 = /* @__PURE__ */ h("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 20 20",
  fill: "currentColor",
    ...
    return (p, f) => (g(), w(R, null, [
      ...
      h("ol", q0, [
        ...
        (g(!0), w(R, null, G($(n), (d) => (g(), w("li", null, [
          ...
          d.children ? (g(), w("ol", J0, [
            (g(!0), w(R, null, G(d.children, (v) => (g(), w("li", G0, [
              h("a", {
                href: v.link,
                onClick: l,
...
const e1 = { class: "mt-12 flex border-t border-slate-200 pt-6 dark:border-slate-800" }, t1 = { key: 0 }, n1 = /* @__PURE__ */ h("dt", { class: "font-display text-sm font-medium text-slate-900 dark:text-white" }, " Previous ", -1), r1 = { class: "mt-1" }, o1 = ["href"], i1 = /* @__PURE__ */ h("span", { "aria-hidden": "true" }, "\u2190", -1), s1 = ["innerHTML"], a1 = {
  key: 1,
  class: "ml-auto text-right"
}, l1 = /* @__PURE__ */ h("dt", { class: "font-display text-sm font-medium text-slate-900 dark:text-white" }, " Next ", -1), c1 = { class: "mt-1" }, u1 = ["href"], d1 = ["innerHTML"], f1 = /* @__PURE__ */ h("span", { "aria-hidden": "true" }, "\u2192", -1), p1 = /* @__PURE__ */ N({
  __name: "PrevNextLinks",
  setup(e) {
    const t = X0();
    return (n, r) => (g(), w("dl", e1, [
      $(t).prev ? (g(), w("div", t1, [
        n1,
        h("dd", r1, [
          h("a", {
...
const m1 = {
...
}, v1 = { class: "flex w-full" }, _1 = { class: "min-w-0 flex-auto" }, g1 = /* @__PURE__ */ h("div", { class: "mx-2 rounded-b-md bg-amber-100/70 px-4 py-2 text-amber-900 dark:mt-px dark:bg-amber-400/10 dark:text-amber-300 dark:ring-1 dark:ring-amber-300/30" }, [
...
], -1), y1 = { class: "mt-4 flex h-[42px] items-center" }, b1 = { class: "px-6 pt-10 pb-[70vh] xl:px-10" }, w1 = {
  key: 0,
  id: "header"
}, x1 = {
  key: 0,
  class: "mb-2 text-base font-semibold leading-6 text-blue-500 dark:text-cyan-400"
}, O1 = { class: "text-2xl font-bold tracking-tight text-slate-900 dark:text-slate-200 sm:text-4xl" }, k1 = { class: "mt-2 text-lg text-slate-700 dark:text-slate-400" }, S1 = { class: "hidden w-72 flex-none xl:block" }, $1 = { class: "h-sidebar sticky top-[72px] overflow-y-auto overflow-x-hidden" }, P1 = { class: "pt-16 pb-10 pr-3" }, E1 = ["href"], C1 = /* @__PURE__ */ N({
  __name: "default",
  setup(e) {
    const { page: t } = Ee(), n = h1(), r = en(), o = M(() => zr(r.value)), i = M(() => o.value.find(
      ...
      return g(), w("div", m1, [
        h("div", v1, [
          h("div", _1, [
            g1,
            h("div", y1, [
              B(D0, { class: "px-6 xl:px-10" })
            ]),
            h("div", b1, [
              $(s) ? (g(), w("header", w1, [
                $(a) ? (g(), w("p", x1, F($(a)), 1)) : K("", !0),
                h("h1", O1, F($(s)), 1),
                h("p", k1, F($(t).description), 1)
              ])) : K("", !0),
  ...
  id: "content",
  class: "static max-h-full w-full min-w-0 flex-auto overflow-y-visible"
}, T1 = { class: "flex w-full" }, I1 = { class: "min-w-0 flex-auto" }, A1 = { class: "px-6 pt-10 xl:px-10" }, N1 = /* @__PURE__ */ h("header", { id: "header" }, [
...
], -1), D1 = { class: "prose-headings:font-display prose prose-slate mx-auto mt-4 max-w-none prose-a:font-semibold prose-lead:text-slate-500 dark:prose-invert dark:prose-a:text-cyan-400 dark:prose-hr:border-slate-800 dark:prose-lead:text-slate-400" }, L1 = /* @__PURE__ */ h("p", null, " This page doesn't exist or has been removed. Perhaps not included in the docs yet? ", -1), M1 = /* @__PURE__ */ h("a", {
  href: "/",
  class: "rounded-md bg-blue-500 px-4 py-2 text-lg text-white no-underline"
}, "Go Home", -1), R1 = /* @__PURE__ */ h("p", null, "Here are some links that may be what you are looking for:", -1), H1 = ["href"], Dn = /* @__PURE__ */ N({
  __name: "NotFound",
  setup(e) {
    const t = Jt(), n = z([]);
...
}, z1 = { class: "mx-auto lg:px-6 2xl:container" }, V1 = { class: "flex" }, F1 = { class: "hidden lg:relative lg:block lg:flex-none" }, U1 = /* @__PURE__ */ h("div", { class: "absolute inset-y-0 right-0 w-[50vw] bg-slate-50 dark:hidden" }, null, -1), q1 = /* @__PURE__ */ h("div", { class: "absolute top-12 bottom-0 right-0 hidden h-12 w-px bg-gradient-to-t from-slate-800 dark:block" }, null, -1), W1 = /* @__PURE__ */ h("div", { class: "absolute top-24 bottom-0 right-0 hidden w-px bg-slate-800 dark:block" }, null, -1), K1 = { class: "h-sidebar sticky top-[72px] overflow-y-auto overflow-x-hidden overscroll-contain" }, J1 = { class: "w-64 pt-4 pr-4 pb-10 xl:w-72" }, G1 = { class: "flex items-center" }, Q1 = /* @__PURE__ */ N({
  __name: "Layout",
  setup(e) {
    const { theme: t } = Ee(), n = Jt();
    return (r, o) => (g(), w("div", B1, [
      B($(O0), {
        mainURL: $(t).mainURL
      }, {
        right: ye(() => [
      ...
      h("div", z1, [
        h("div", V1, [
          ...
          $(n).component === Dn ? (g(), se(Dn, { key: 0 })) : (g(), se(C1, { key: 1 }))
        ])
      ])
    ]));
  }
});
const Y1 = { class: "mt-10 mb-16" }, Z1 = { class: "border-b border-gray-200 dark:border-white/5" }, X1 = { class: "z-10 -mb-px flex" }, em = ["onClick"], tm = /* @__PURE__ */ N({
  __name: "FlavorTabs",
  setup(e) {
    const { value: t, set: n } = Bs(), r = z([]), o = z(), i = z(), s = () => {
      var l;
...
}), nm = { class: "mt-10 mb-4" }, rm = { class: "" }, om = { class: "z-10 flex rounded-t-md border border-white/10 bg-gray-900 dark:bg-transparent" }, im = ["onClick"], sm = /* @__PURE__ */ N({
  __name: "CodeTabs",
  setup(e) {
    const t = z(0), n = z(), r = z([]), o = () => {
...
const am = { class: "flex flex-col" }, lm = {
  key: 0,
  class: "flex h-5 items-center justify-center"
}, cm = /* @__PURE__ */ h("div", { class: "h-5 w-20 rounded-full ring-1 ring-ns-blue dark:ring-cyan-700" }, null, -1), um = /* @__PURE__ */ h("div", { class: "ml-4 h-5 w-5 rounded-full ring-1 ring-ns-blue dark:ring-cyan-700" }, null, -1), dm = [
  cm,
  um
], fm = {
  key: 1,
  class: "flex h-5 items-center justify-center"
}, pm = /* @__PURE__ */ h("span", { class: "flex h-5 w-5 items-center justify-center rounded-full ring-1 ring-ns-blue dark:ring-cyan-700" }, [
  ...
  setup(e) {
    return (t, n) => (g(), w("div", {
      ...
      h("div", am, [
        e.type === "ios" ? (g(), w("div", lm, dm)) : e.type === "android" ? (g(), w("div", fm, hm)) : K("", !0),
        h("div", {
...
}), _m = { class: "not-prose" }, gm = ["href"], ym = /* @__PURE__ */ h("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 20 20",
  fill: "currentColor",
  class: "ml-3 h-5 w-5"
...
}, Om = /* @__PURE__ */ h("g", { transform: "matrix(1,0,0,1,-2248,0)" }, [
  /* @__PURE__ */ h("g", {
...
function Sm(e, t) {
  return g(), w("svg", xm, km);
}
const mt = /* @__PURE__ */ St(wm, [["render", Sm]]), $m = { class: "not-prose -mx-4 grid grid-cols-4 gap-4" }, Pm = ["href"], Em = { class: "ml-4" }, Cm = /* @__PURE__ */ h("div", { class: "text-lg font-semibold" }, "NativeScript", -1), jm = { class: "text-sm" }, Tm = /* @__PURE__ */ N({
...
}), Am = { class: "flex items-baseline" }, Nm = {
  key: 0,
  class: "ml-2"
}, Dm = { class: "space-y-4" }, Lm = { class: "pb-2" }, Mm = { class: "relative" }, Rm = ["id", "href"], Hm = ["innerHTML"], Bm = { class: "text-right text-sm text-slate-500" }, zm = { key: 0 }, Vm = ["href"], Fm = ["href"], Um = {
  key: 0,
...
], -1), Wm = { class: "ml-2" }, Km = ["innerHTML"], Jm = /* @__PURE__ */ N({
  __name: "APIRef",
  props: {
    for: null
  },
  setup(e) {
    ...
    return (a, l) => {
      var p, f;
      const u = ve("APIRefComment"), c = ve("APIRefParameters");
      return g(), w(R, null, [
        h("div", Am, [
          Pe(a.$slots, "title"),
          (p = $(r)) != null && p.flags ? (g(), w("div", Nm, [
            B(Im, {
              flags: $(r).flags
            }, null, 8, ["flags"])
          ])) : K("", !0)
          ...
          (g(!0), w(R, null, G((f = $(r)) == null ? void 0 : f.signatures, (d) => {
            ...
            return g(), w("div", Lm, [
              ...
              h("div", {
                ...
                h("div", Bm, [
                  d.inheritedFrom ? (g(), w("div", zm, [
                    Te(" inherited from "),
                    h("a", {
                      href: d.inheritedFrom.url
                    }, F(d.inheritedFrom.name), 9, Vm)
                  ])) : K("", !0),
...
process.env.NODE_ENV !== "production" && Object.freeze([]);
const Ym = () => {
}, Zm = Object.assign, Xm = Array.isArray, e2 = (e) => typeof e == "function", t2 = (e) => typeof e == "symbol";
let n2;
function r2(e, t = n2) {
...
}, Ea = (e) => (e.w & et) > 0, Ca = (e) => (e.n & et) > 0, o2 = ({ deps: e }) => {
  if (e.length)
    for (let t = 0; t < e.length; t++)
      e[t].w |= et;
}, i2 = (e) => {
...
class s2 {
  constructor(t, n = null, r) {
    this.fn = t, this.scheduler = n, this.active = !0, this.deps = [], this.parent = void 0, r2(this, r);
  }
  run() {
    if (!this.active)
      return this.fn();
    ...
    try {
      return this.parent = xe, xe = this, gn = !0, et = 1 << ++Dt, Dt <= Nr ? o2(this) : Ui(this), this.fn();
    } finally {
      Dt <= Nr && i2(this), et = 1 << --Dt, xe = this.parent, gn = n, this.parent = void 0, this.deferStop && this.stop();
    }
  }
  stop() {
    xe === this ? this.deferStop = !0 : this.active && (Ui(this), this.onStop && this.onStop(), this.active = !1);
  }
}
function Ui(e) {
  const { deps: t } = e;
...
function qi(e, t) {
  let n = !1;
  Dt <= Nr ? Ca(e) || (e.n |= et, n = !Ea(e)) : n = !e.has(xe), n && (e.add(xe), xe.deps.push(e), process.env.NODE_ENV !== "production" && xe.onTrack && xe.onTrack(Object.assign({ effect: xe }, t)));
}
function Wi(e, t) {
  const n = Xm(e) ? e : [...e];
  for (const r of n)
...
function Ki(e, t) {
  (e !== xe || e.allowRecurse) && (process.env.NODE_ENV !== "production" && e.onTrigger && e.onTrigger(Zm({ effect: e }, t)), e.scheduler ? e.scheduler() : e.run());
}
new Set(
  /* @__PURE__ */ Object.getOwnPropertyNames(Symbol).filter((e) => e !== "arguments" && e !== "caller").map((e) => Symbol[e]).filter(t2)
);
function Wn(e) {
  const t = e && e.__v_raw;
  return t ? Wn(t) : e;
...
function a2(e) {
  gn && xe && (e = Wn(e), process.env.NODE_ENV !== "production" ? qi(e.dep || (e.dep = Fi()), {
    target: e,
    type: "get",
    key: "value"
  }) : qi(e.dep || (e.dep = Fi())));
...
class c2 {
  constructor(t, n, r, o) {
    this._setter = n, this.dep = void 0, this.__v_isRef = !0, this[ja] = !1, this._dirty = !0, this.effect = new s2(t, () => {
      this._dirty || (this._dirty = !0, l2(this));
    }), this.effect.computed = this, this.effect.active = this._cacheable = !o, this.__v_isReadonly = r;
  }
  get value() {
    const t = Wn(this);
    return a2(t), (t._dirty || !t._cacheable) && (t._dirty = !1, t._value = t.effect.run()), t._value;
  }
  set value(t) {
    this._setter(t);
  }
...
function u2(e, t, n = !1) {
  ...
  const s = new c2(r, o, i || !o, n);
  return process.env.NODE_ENV !== "production" && t && !n && (s.effect.onTrack = t.onTrack, s.effect.onTrigger = t.onTrigger), s;
}
const d2 = { class: "flex items-start" }, f2 = { class: "columns-1 gap-8 sm:columns-2 md:columns-3 lg:columns-4" }, p2 = ["href"], h2 = {
  key: 1,
  ...
  setup(e) {
    ...
    return (r, o) => {
      const i = ve("APIRefHierarchyItem", !0);
      return $(n) ? (g(), w("div", {
        key: 0,
        class: Q({ "pl-4": !e.root })
      }, [
        h("div", d2, [
          ...
          h("div", f2, [
            (g(!0), w(R, null, G($(n), (s) => (g(), w(R, null, [
              ...
              }, F(s.text), 9, p2)) : (g(), w("span", h2, F(s.text), 1))
            ], 64))), 256))
          ])
        ]),
...
}), v2 = { class: "mt-6 font-medium" }, _2 = /* @__PURE__ */ N({
  ...
  key: 0,
  class: "not-prose mt-4"
}, y2 = { class: "not-prose mt-4" }, b2 = { class: "-mx-4 overflow-x-auto sm:mx-0" }, w2 = { class: "inline-block min-w-full" }, x2 = { class: "w- w-full min-w-[540px] border-b border-slate-200 text-left dark:border-slate-700 sm:min-w-full" }, O2 = { class: "divide-y divide-slate-200 dark:divide-slate-700" }, k2 = /* @__PURE__ */ h("tr", { class: "w-1/4 text-slate-900 dark:text-slate-400" }, [
...
], -1), S2 = { class: "" }, $2 = { class: "prose-sm prose prose-slate py-3 pl-4 align-baseline dark:prose-invert sm:pl-0" }, P2 = ["innerHTML"], E2 = { class: "prose-sm prose prose-slate py-3 align-baseline dark:prose-invert" }, C2 = { class: "" }, j2 = { class: "py-3 align-baseline" }, T2 = { class: "prose-sm prose prose-slate my-0 space-x-5 whitespace-nowrap dark:prose-invert [&_a]:text-blue-500 dark:[&_a]:text-cyan-400" }, I2 = ["innerHTML"], A2 = { class: "prose-sm prose prose-slate dark:prose-invert" }, N2 = /* @__PURE__ */ N({
  ...
  setup(e) {
    return (t, n) => {
      var o;
      const r = ve("APIRefComment");
      return (o = e.parameters) != null && o.length ? (g(), w("div", g2, [
        h("div", y2, [
          h("div", b2, [
            h("div", w2, [
              h("table", x2, [
                h("tbody", O2, [
                  k2,
                  (g(!0), w(R, null, G(e.parameters, (i) => (g(), w("tr", S2, [
                    h("td", $2, [
                      h("code", {
                        innerHTML: i.name
                      }, null, 8, P2)
...
}), { createElementVNode: D2, openBlock: L2, createElementBlock: M2 } = Ve;
var R2 = function(t, n) {
  return L2(), M2("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 20 20",
...
const { createElementVNode: H2, openBlock: B2, createElementBlock: z2 } = Ve;
var V2 = function(t, n) {
  return B2(), z2("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 20 20",
...
const U2 = { key: 0 }, q2 = { key: 0 }, W2 = { class: "columns-1 gap-4 sm:columns-2 2xl:columns-3" }, K2 = ["href"], J2 = ["innerHTML"], G2 = { class: "-mx-4 mt-4 rounded-lg border border-slate-200 dark:border-slate-700" }, Q2 = ["onClick"], Y2 = { class: "ml-2" }, Z2 = ["href", "innerHTML"], X2 = ["innerHTML"], ev = { class: "flex-1 text-right text-xs" }, tv = { class: "columns-1 p-4 sm:columns-2 2xl:columns-3" }, nv = ["href"], rv = ["innerHTML"], ov = /* @__PURE__ */ N({
          ...
          h("dl", W2, [
            (g(!0), w(R, null, G($(r)(f), (d) => (g(), w("dd", null, [
              h("a", {
                ...
                B($(Ji), { class: "mr-1.5 h-5 w-5 flex-shrink-0" }),
                h("span", {
                  innerHTML: d.name
                }, null, 8, J2)
              ], 8, K2)
          ...
          wt(h("div", G2, [
            (g(!0), w(R, null, G($(o)(f), (d) => (g(), w("div", null, [
              h("div", {
                ...
                h("span", Y2, F(d.items.length) + " " + F(f.title.toLowerCase()) + " inherited from ", 1),
                d.url ? (g(), w("a", {
                  key: 0,
                ...
                h("div", ev, F($(u)(`${f.title}-${d.name}`) ? "Click to collapse" : "Click to expand"), 1)
              ], 8, Q2),
              wt(h("dl", tv, [
  ...
  enhanceApp(t) {
    ...
    n.component("FlavorTabs", tm), n.component("CodeTabs", sm), n.component("NotFound", Dn), n.component("DeviceFrame", mm), n.component("Heading", vm), n.component("ExternalButtonLink", bm), n.component("StackBlitzLinks", Tm), n.component("APIRef", Jm), n.component("APIRefComment", Qm), n.component("APIRefHierarchy", _2), n.component("APIRefParameters", N2), n.component("APIRefSummary", ov), n.provide("useRouter", Gi), n.provide("useRoute", Jt), n.provide(Hs, Tu()), n.use(vc, {
      instantMove: !0,
      distance: 10,
      themes: {
        tooltip: {
