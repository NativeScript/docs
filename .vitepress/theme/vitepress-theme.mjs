import { inBrowser as Ir, useData as De, useRoute as pn, useRouter as Cl } from "vitepress";
import { pushScopeId as jl, popScopeId as Tl, defineComponent as D, nextTick as or, openBlock as _, createBlock as ce, createElementBlock as w, normalizeClass as Z, renderSlot as Re, normalizeProps as Al, guardReactiveProps as Il, withScopeId as Dl, resolveComponent as xe, normalizeStyle as _r, withKeys as Nl, createElementVNode as h, Fragment as F, createCommentVNode as J, withCtx as pe, createVNode as B, ref as T, createApp as Ll, h as fe, mergeProps as Ml, toDisplayString as U, cloneVNode as Rl, inject as he, provide as Be, onMounted as se, watchEffect as Oe, computed as A, watch as $e, onUnmounted as Ze, Teleport as Bl, reactive as Hl, unref as $, getCurrentInstance as Ia, getCurrentScope as Fl, onScopeDispose as zl, shallowRef as Vl, isRef as Da, withDirectives as Nt, renderList as X, vModelSelect as Ul, withModifiers as wt, resolveDynamicComponent as hn, vShow as Bn, createStaticVNode as Na, Transition as yr, createTextVNode as Ae, resolveDirective as ql } from "vue";
...
function Ma(e, t) {
  const n = It(e) === "start", r = mn(e), o = ho(r);
...
function ec(e, t, n) {
  return (e ? [...n.filter((o) => It(o) === e), ...n.filter((o) => It(o) !== e)] : n.filter((o) => Xe(o) === o)).filter((o) => e ? It(o) === e || (t ? Lr(o) !== o : !1) : !0);
}
const tc = function(e) {
  return e === void 0 && (e = {}), {
    name: "autoPlacement",
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      if ((n = i.size) != null && n.skip)
        return {};
      const l = await ir(t, s), u = Xe(r), c = It(r) === "end";
      let p, f;
...
function fc(e, t, n) {
  const r = Qe(t), o = ft(t), i = Lt(e, r && dc(t));
  let a = {
    scrollLeft: 0,
    scrollTop: 0
  };
...
function _c(e) {
  const t = Lt(e), n = t.top + e.clientTop, r = t.left + e.clientLeft;
  return {
    top: n,
    left: r,
    x: r,
  ...
  methods: {
    ...
    async $_applyHide(e = !1) {
      ...
      if (clearTimeout(this.$_scheduleTimer), !this.isShown)
        return;
      this.skipTransition = e, zo(Le, this), Le.length === 0 && document.body.classList.remove("v-popper--some-open");
...
function Ko(e, { value: t, modifiers: n }) {
  const r = Ya(e, t, n);
  if (!r.content || Mt(r.theme || "tooltip", "disabled"))
    Za(e);
  else {
    let o;
...
function xu(e, t = 0) {
  var n;
  return e === ((n = Rt(e)) == null ? void 0 : n.body) ? !1 : Me(t, { [0]() {
    return e.matches(Hr);
  }, [1]() {
    let r = e;
    for (; r !== null; ) {
...
let Vt = Object.assign(D({ name: "FocusTrap", props: { as: { type: [Object, String], default: "div" }, initialFocus: { type: Object, default: null }, features: { type: Number, default: 30 }, containers: { type: Object, default: T(/* @__PURE__ */ new Set()) } }, inheritAttrs: !1, setup(e, { attrs: t, slots: n, expose: r }) {
  ...
  function l() {
    let u = Ie(o);
    !u || Me(s.value, { [zr.Forwards]: () => Fr(u, an.First), [zr.Backwards]: () => Fr(u, an.Last) });
  }
  return () => {
...
let Yo = "body > *", kt = /* @__PURE__ */ new Set(), at = /* @__PURE__ */ new Map();
function Zo(e) {
      ...
      o.querySelectorAll(Yo).forEach((i) => {
        if (i instanceof HTMLElement) {
          for (let a of kt)
            if (i.contains(a))
              return;
          kt.size === 1 && (at.set(i, { "aria-hidden": i.getAttribute("aria-hidden"), inert: i.inert }), Zo(i));
        }
      }), n(() => {
...
let us = D({ name: "Portal", props: { as: { type: [Object, String], default: "div" } }, setup(e, { slots: t, attrs: n }) {
  let r = T(null), o = A(() => Rt(r)), i = Mu(), a = he(ds, null), s = T(i === !0 || a == null ? Ru(r.value) : a.resolveTarget());
  return Oe(() => {
...
let Fg = D({ name: "Description", props: { as: { type: [Object, String], default: "p" } }, setup(e, { attrs: t, slots: n }) {
...
let xn = "DC8F892D-2EBD-447C-A4C8-A03058436FF4", qu = D({ name: "Dialog", inheritAttrs: !1, props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: !1 }, unmount: { type: Boolean, default: !0 }, open: { type: [Boolean, String], default: xn }, initialFocus: { type: Object, default: null } }, emits: { close: (e) => !0 }, setup(e, { emit: t, attrs: n, slots: r, expose: o }) {
  ...
  let s = T(0), l = _o(), u = A(() => e.open === xn && l !== null ? Me(l.value, { [Ot.Open]: !0, [Ot.Closed]: !1 }) : e.open), c = T(/* @__PURE__ */ new Set()), p = T(null), f = T(null), d = A(() => Rt(p));
  ...
  return Be(qr, M), $u(() => {
    ...
    return fe(Vr, { force: !0 }, () => [fe(us, () => fe(Bu, { target: p.value }, () => fe(Vr, { force: !1 }, () => fe(Vt, { initialFocus: C, containers: c, features: g.value ? Me(k.value, { parent: Vt.features.RestoreFocus, leaf: Vt.features.All & ~Vt.features.FocusLock }) : Vt.features.None }, () => be({ ourProps: E, theirProps: R, slot: H, attrs: n, slots: r, visible: v.value === 0, features: Un.RenderStrategy | Un.Static, name: "Dialog" }))))), fe(Wn, { features: sn.Hidden, ref: f })]);
  };
} });
...
let zg = D({ name: "Label", props: { as: { type: [Object, String], default: "label" }, passive: { type: [Boolean], default: !1 } }, setup(e, { slots: t, attrs: n }) {
...
let ys = Un.RenderStrategy, Kr = D({ props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: !0 }, appear: { type: [Boolean], default: !1 }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => !0, afterEnter: () => !0, beforeLeave: () => !0, afterLeave: () => !0 }, setup(e, { emit: t, attrs: n, slots: r, expose: o }) {
  ...
  }), Be(wo, g), _u(A(() => Me(a.value, { visible: Ot.Open, hidden: Ot.Closed }))), () => {
  ...
  let o = _o(), i = A(() => e.show === null && o !== null ? Me(o.value, { [Ot.Open]: !0, [Ot.Closed]: !1 }) : e.show);
  Oe(() => {
...
const $t = Fd(), Gd = /* @__PURE__ */ h("span", { class: "sr-only" }, "Toggle Dark Mode", -1), Qd = /* @__PURE__ */ h("svg", {
    ...
    return (t, n) => {
      ...
      return _(), ce(r, null, {
        default: pe(() => [
          B($(Ju), {
            modelValue: $($t),
            "onUpdate:modelValue": n[0] || (n[0] = (o) => Da($t) ? $t.value = o : null),
            class: Z([
            ...
            default: pe(() => [
              ...
              h("span", {
                ...
                h("span", {
                  class: Z([
                    $($t) ? "opacity-0 duration-100 ease-out" : "opacity-100 duration-200 ease-in",
                ...
                h("span", {
                  class: Z([
                    $($t) ? "opacity-100 duration-200 ease-in" : "opacity-0 duration-100 ease-out",
                    "absolute inset-0 flex h-full w-full items-center justify-center transition-opacity"
                  ]),
                  "aria-hidden": "true"
                }, Xd, 2)
...
}), vf = { class: "sticky top-0 z-10 border-b bg-gray-50 p-4 dark:border-white/10 dark:bg-gray-900 lg:hidden" }, gf = /* @__PURE__ */ h("span", { class: "ml-2 text-sm" }, "Menu", -1), _f = { class: "fixed inset-0 overflow-hidden" }, yf = { class: "absolute inset-0 overflow-hidden" }, bf = { class: "pointer-events-none fixed inset-y-0 left-0 flex max-w-full pr-10" }, wf = { class: "flex h-full flex-col overflow-y-scroll bg-white py-6 shadow-xl dark:bg-gray-900 dark:shadow-cyan-400/20" }, xf = { class: "relative flex-1 px-4 sm:px-6" }, Of = {
  role: "list",
  class: "space-y-1"
}, Sf = /* @__PURE__ */ D({
...
const jf = /* @__PURE__ */ Bt(kf, [["render", Cf]]), Tf = {}, Af = {
  xmlns: "http://www.w3.org/2000/svg",
  fill: "none",
  viewBox: "0 0 24 24",
  "stroke-width": "1.5",
...
const Lf = /* @__PURE__ */ Bt(Tf, [["render", Nf]]), Mf = {}, Rf = {
  xmlns: "http://www.w3.org/2000/svg",
  fill: "none",
  viewBox: "0 0 24 24",
  "stroke-width": "1.5",
...
const zf = /* @__PURE__ */ Bt(Mf, [["render", Ff]]), Vf = {}, Uf = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 20 20",
  fill: "currentColor",
  class: "h-5 w-5"
...
const In = /* @__PURE__ */ Bt(Vf, [["render", Kf]]), Jf = {
  key: 0,
  class: "mt-4"
  ...
  setup(e) {
    const t = e, n = {
      ...
      cube: zf,
      chevron_right: In
    }, { page: r, site: o } = De(), i = t.item.text, a = p(o.value.base, t.item.link), s = t.item.items, l = A(() => St(r.value.relativePath, t.item.link)), u = t.item.icon && n[t.item.icon], c = T(!!t.item.hideChildren);
    function p(f, d) {
...
var Ht, we, Oi, Dt = 0, Xr = [], Si = N.__b, ki = N.__r, $i = N.diffed, Pi = N.__c, Ei = N.unmount;
function bn(e, t) {
...
function Qh(e) {
  ...
  return { getEnvironmentProps: function(i) {
    ...
    var a;
    function s(g) {
      (t.openOnFocus || Boolean(r.getState().query)) && jt(ye({ event: g, props: t, query: r.getState().completion || r.getState().query, refresh: n, store: r }, o)), r.dispatch("focus", null);
    }
    var l = i || {}, u = (l.inputElement, l.maxLength), c = u === void 0 ? 512 : u, p = Kt(l, Kh), f = Tt(r.getState()), d = function(g) {
    ...
    return ye({ "aria-autocomplete": "both", "aria-activedescendant": r.getState().isOpen && r.getState().activeItemId !== null ? "".concat(t.id, "-item-").concat(r.getState().activeItemId) : void 0, "aria-controls": r.getState().isOpen ? "".concat(t.id, "-list") : void 0, "aria-labelledby": "".concat(t.id, "-label"), value: r.getState().completion || r.getState().query, id: "".concat(t.id, "-input"), autoComplete: "off", autoCorrect: "off", autoCapitalize: "off", enterKeyHint: v, spellCheck: "false", autoFocus: t.autoFocus, placeholder: t.placeholder, maxLength: c, type: "search", onChange: function(g) {
      jt(ye({ event: g, props: t, query: g.currentTarget.value.slice(0, c), refresh: n, store: r }, o));
      ...
      (function(y) {
        ...
        if (b.key === "ArrowUp" || b.key === "ArrowDown") {
          ...
          b.preventDefault(), x.getState().isOpen === !1 && (k.openOnFocus || Boolean(x.getState().query)) ? jt(_t({ event: b, props: k, query: x.getState().query, refresh: S, store: x }, P)).then(function() {
          ...
          b.preventDefault();
          var j = Tt(x.getState()), C = j.item, R = j.itemInputValue, H = j.itemUrl, Y = j.source;
          if (b.metaKey || b.ctrlKey)
            ...
            jt(_t({ event: b, nextState: { isOpen: !1 }, props: k, query: R, refresh: S, store: x }, P)).then(function() {
    ...
    return ye({ id: "".concat(t.id, "-item-").concat(a.__autocomplete_id), role: "option", "aria-selected": r.getState().activeItemId === a.__autocomplete_id, onMouseMove: function(u) {
      ...
      (p ? Promise.resolve() : jt(ye({ event: u, nextState: { isOpen: !1 }, props: t, query: c, refresh: n, store: r }, o))).then(function() {
...
function oa(e) {
  var t, n = e.state;
  return n.isOpen === !1 || n.activeItemId === null ? null : ((t = Tt(n)) === null || t === void 0 ? void 0 : t.itemInputValue) || null;
}
function ia(e, t) {
  var n = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
...
function n0(e) {
  ...
  var t = [], n = function(s, l) {
    ...
    return Pt(Pt({ debug: !1, openOnFocus: !1, placeholder: "", autoFocus: !1, defaultActiveItemId: null, stallThreshold: 300, environment: c, shouldPanelOpen: function(f) {
      ...
      return f.sources;
    } }, s), {}, { id: (u = s.id) !== null && u !== void 0 ? u : "autocomplete-".concat(wh++), plugins: p, initialState: Pt({ activeItemId: null, query: "", completion: null, collections: [], isOpen: !1, status: "idle", context: {} }, s.initialState), onStateChange: function(f) {
      var d;
      ...
      return Promise.all([].concat(Th(p.map(function(d) {
        ...
        return d.map(function(v) {
          return Pt(Pt({}, v), {}, { onSelect: function(g) {
  ...
  function a() {
    return jt(yt({ event: new Event("input"), nextState: { isOpen: r.getState().isOpen }, props: n, query: r.getState().query, refresh: a, store: r }, o));
  }
...
function O0(e) {
  ...
  return m.createElement("li", Xn({ className: ["DocSearch-Hit", t.__docsearch_parent && "DocSearch-Hit--Child", c && "DocSearch-Hit--deleting", d && "DocSearch-Hit--favoriting"].filter(Boolean).join(" "), onTransitionEnd: function() {
    ...
    a(t);
  } })), m.createElement(y, { hit: t }, m.createElement("div", { className: "DocSearch-Hit-Container" }, r({ item: t, index: n }), t.hierarchy[t.type] && t.type === "lvl1" && m.createElement("div", { className: "DocSearch-Hit-content-wrapper" }, m.createElement(Et, { className: "DocSearch-Hit-title", hit: t, attribute: "hierarchy.lvl1" }), t.content && m.createElement(Et, { className: "DocSearch-Hit-path", hit: t, attribute: "content" })), t.hierarchy[t.type] && (t.type === "lvl2" || t.type === "lvl3" || t.type === "lvl4" || t.type === "lvl5" || t.type === "lvl6") && m.createElement("div", { className: "DocSearch-Hit-content-wrapper" }, m.createElement(Et, { className: "DocSearch-Hit-title", hit: t, attribute: "hierarchy.".concat(t.type) }), m.createElement(Et, { className: "DocSearch-Hit-path", hit: t, attribute: "hierarchy.lvl1" })), t.type === "content" && m.createElement("div", { className: "DocSearch-Hit-content-wrapper" }, m.createElement(Et, { className: "DocSearch-Hit-title", hit: t, attribute: "content" }), m.createElement(Et, { className: "DocSearch-Hit-path", hit: t, attribute: "hierarchy.lvl1" })), o({ item: t, runDeleteTransition: function(b) {
    p(!0), g.current = b;
...
var At = { Read: 1, Write: 2, Any: 3 }, cl = 1, z0 = 2, ul = 3;
function dl(e) {
  var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : cl;
  return Q(Q({}, e), {}, { status: t, lastUpdate: Date.now() });
}
function fl(e) {
  return typeof e == "string" ? { protocol: "https", url: e, accept: At.Any } : { protocol: e.protocol || "https", url: e.url, accept: e.accept || At.Any };
}
var ga = "GET", mr = "POST";
function V0(e, t) {
...
var W0 = function(e) {
  var t = e.appId, n = function(i, a, s) {
    ...
    return g;
  }(Q(Q({ hosts: [{ url: "".concat(t, "-dsn.algolia.net"), accept: At.Read }, { url: "".concat(t, ".algolia.net"), accept: At.Write }].concat(F0([{ url: "".concat(t, "-1.algolianet.com") }, { url: "".concat(t, "-2.algolianet.com") }, { url: "".concat(t, "-3.algolianet.com") }])) }, e), {}, { headers: Q(Q(Q({}, n.headers()), { "content-type": "application/x-www-form-urlencoded" }), e.headers), queryParameters: Q(Q({}, n.queryParameters()), e.queryParameters) })), o = { transporter: r, appId: t, addAlgoliaAgent: function(i, a) {
      ...
      return G ? ie.search([{ query: G, indexName: r, params: Ar({ attributesToRetrieve: ["hierarchy.lvl0", "hierarchy.lvl1", "hierarchy.lvl2", "hierarchy.lvl3", "hierarchy.lvl4", "hierarchy.lvl5", "hierarchy.lvl6", "content", "type", "url"], attributesToSnippet: ["hierarchy.lvl1:".concat(O.current), "hierarchy.lvl2:".concat(O.current), "hierarchy.lvl3:".concat(O.current), "hierarchy.lvl4:".concat(O.current), "hierarchy.lvl5:".concat(O.current), "hierarchy.lvl6:".concat(O.current), "content:".concat(O.current)], snippetEllipsisText: "\u2026", highlightPreTag: "<mark>", highlightPostTag: "</mark>", hitsPerPage: 20 }, a) }]).catch(function(re) {
        ...
        return ae.context.searchSuggestions.length < Object.keys(ht).length && ue({ searchSuggestions: Object.keys(ht) }), ue({ nbHits: Ue }), Object.values(ht).map(function(mt, Ft) {
          return { sourceId: "hits".concat(Ft), onSelect: function(Te) {
            var rt = Te.item, Ne = Te.event;
            je(rt), Ne.shiftKey || Ne.ctrlKey || Ne.metaKey || l();
            ...
            return Object.values(pa(mt, function(Te) {
              ...
              return Te.map(function(rt) {
                return Ar(Ar({}, rt), {}, { __docsearch_parent: rt.type !== "lvl1" && Te.find(function(Ne) {
                  return Ne.type === "lvl1" && Ne.hierarchy.lvl1 === rt.hierarchy.lvl1;
                }) });
              });
            }).flat();
          } };
...
const sm = /* @__PURE__ */ Bt(nm, [["render", am]]), lm = {
  class: "flex",
  ...
  __name: "Breadcrumbs",
  setup(e) {
    const t = yn(), { page: n } = De(), r = A(() => xo(t.value)), o = A(() => {
      const i = [];
  ...
  (function(n, r) {
    ...
    var H = function() {
      ...
      function Po(_e) {
        if (Ue)
          return Eo();
        Ne || (Ne = _e), te || $o(), gr = _e - Ne, zt = Math.min(gr / V, 1), zt = rt(zt), Co(I, Pe + ge * zt, ae + de * zt), gr < V ? window.requestAnimationFrame(Po) : Eo();
      }
      function Eo() {
        Ue || Co(I, re, ue), Ne = !1, E.off(I, j, Te), Ue && nt && nt(Ft, O), !Ue && me && me(O);
      }
...
const yl = _l.exports, xm = /* @__PURE__ */ h("div", { class: "text-sm font-semibold leading-6 text-gray-900 dark:text-white" }, " On this page ", -1), Om = { class: "mt-4 text-sm leading-6 text-slate-700 dark:text-slate-400" }, Sm = ["onClick"], km = ["href"], $m = { key: 0 }, Pm = { class: "" }, Em = ["href"], Cm = /* @__PURE__ */ h("svg", {
  ...
  __name: "OnThisPage",
  setup(e) {
    const { page: t } = De(), n = A(() => t.value.headers), r = A(() => n.value.flatMap((p) => [
      p.link,
...
const Km = {
  ...
  __name: "default",
  setup(e) {
    const { page: t } = De(), n = Wm(), r = yn(), o = A(() => xo(r.value)), i = A(() => o.value.find(
...
const Ct = /* @__PURE__ */ Bt(X2, [["render", rv]]), ov = { class: "not-prose -mx-4 grid grid-cols-4 gap-4" }, iv = ["href"], av = { class: "ml-4" }, sv = /* @__PURE__ */ h("div", { class: "text-lg font-semibold" }, "NativeScript", -1), lv = { class: "text-sm" }, cv = /* @__PURE__ */ D({
...
}), dv = { class: "flex items-baseline" }, fv = {
  key: 0,
  class: "ml-2"
}, pv = { class: "space-y-4" }, hv = { class: "pb-2" }, mv = { class: "relative" }, vv = ["id", "href"], gv = ["innerHTML"], _v = {
  key: 2,
  class: "mt-4 mb-0 whitespace-normal [&_a]:text-blue-400 [&_a]:no-underline"
}, yv = ["href"], bv = { class: "text-right text-sm text-slate-500" }, wv = { key: 0 }, xv = ["href"], Ov = ["href"], Sv = {
  key: 0,
...
], -1), $v = { class: "ml-2" }, Pv = ["innerHTML"], Ev = /* @__PURE__ */ D({
  __name: "APIRef",
  props: {
    for: null
  },
      ...
      return _(), w(F, null, [
        ...
        `)
              ...
              h("div", {
                ...
                h("div", bv, [
                  d.inheritedFrom ? (_(), w("div", wv, [
                    Ae(" inherited from "),
                    h("a", {
                      href: d.inheritedFrom.url
                    }, U(d.inheritedFrom.name), 9, xv)
                  ])) : J("", !0),
...
process.env.NODE_ENV !== "production" && Object.freeze([]);
const Tv = () => {
}, Av = Object.assign, Iv = Array.isArray, Dv = (e) => typeof e == "function", Nv = (e) => typeof e == "symbol";
let Lv;
function Mv(e, t = Lv) {
...
}, bl = (e) => (e.w & ut) > 0, wl = (e) => (e.n & ut) > 0, Rv = ({ deps: e }) => {
  if (e.length)
...
class Hv {
  constructor(t, n = null, r) {
    this.fn = t, this.scheduler = n, this.active = !0, this.deps = [], this.parent = void 0, Mv(this, r);
  }
  run() {
    if (!this.active)
      return this.fn();
    ...
    try {
      return this.parent = Ee, Ee = this, Rn = !0, ut = 1 << ++Qt, Qt <= po ? Rv(this) : Ea(this), this.fn();
    } finally {
      Qt <= po && Bv(this), ut = 1 << --Qt, Ee = this.parent, Rn = n, this.parent = void 0, this.deferStop && this.stop();
    }
  }
  stop() {
...
function Ta(e, t) {
  (e !== Ee || e.allowRecurse) && (process.env.NODE_ENV !== "production" && e.onTrigger && e.onTrigger(Av({ effect: e }, t)), e.scheduler ? e.scheduler() : e.run());
}
new Set(
  /* @__PURE__ */ Object.getOwnPropertyNames(Symbol).filter((e) => e !== "arguments" && e !== "caller").map((e) => Symbol[e]).filter(Nv)
);
function vr(e) {
  const t = e && e.__v_raw;
  return t ? vr(t) : e;
...
class Vv {
  constructor(t, n, r, o) {
    this._setter = n, this.dep = void 0, this.__v_isRef = !0, this[xl] = !1, this._dirty = !0, this.effect = new Hv(t, () => {
      this._dirty || (this._dirty = !0, zv(this));
    }), this.effect.computed = this, this.effect.active = this._cacheable = !o, this.__v_isReadonly = r;
  }
  get value() {
    const t = vr(this);
    return Fv(t), (t._dirty || !t._cacheable) && (t._dirty = !1, t._value = t.effect.run()), t._value;
  }
  set value(t) {
    this._setter(t);
  }
...
const qv = { class: "flex items-start" }, Wv = { class: "columns-1 gap-8 sm:columns-2 md:columns-3 lg:columns-4" }, Kv = ["href"], Jv = {
  key: 1,
        ...
        h("div", qv, [
          ...
          h("div", Wv, [
            (_(!0), w(F, null, X($(n), (a) => (_(), w(F, null, [
              ...
              }, U(a.text), 9, Kv)) : (_(), w("span", Jv, U(a.text), 1))
            ], 64))), 256))
          ])
        ]),
...
}), Qv = { class: "mt-6 font-medium" }, Yv = /* @__PURE__ */ D({
  ...
  key: 0,
  class: "not-prose mt-4"
}, Xv = { class: "not-prose mt-4" }, eg = { class: "-mx-4 overflow-x-auto sm:mx-0" }, tg = { class: "inline-block min-w-full" }, ng = { class: "w- w-full min-w-[540px] border-b border-slate-200 text-left dark:border-slate-700 sm:min-w-full" }, rg = { class: "divide-y divide-slate-200 dark:divide-slate-700" }, og = /* @__PURE__ */ h("tr", { class: "w-1/4 text-slate-900 dark:text-slate-400" }, [
...
], -1), ig = { class: "" }, ag = { class: "prose-sm prose prose-slate py-3 pl-4 align-baseline dark:prose-invert sm:pl-0" }, sg = ["innerHTML"], lg = { class: "prose-sm prose prose-slate py-3 align-baseline dark:prose-invert" }, cg = { class: "" }, ug = { class: "py-3 align-baseline" }, dg = { class: "prose-sm prose prose-slate my-0 space-x-5 whitespace-nowrap dark:prose-invert [&_a]:text-blue-500 dark:[&_a]:text-cyan-400" }, fg = ["innerHTML"], pg = { class: "prose-sm prose prose-slate dark:prose-invert" }, hg = /* @__PURE__ */ D({
  ...
  setup(e) {
    return (t, n) => {
      ...
      return (o = e.parameters) != null && o.length ? (_(), w("div", Zv, [
        h("div", Xv, [
          h("div", eg, [
            h("div", tg, [
              h("table", ng, [
                h("tbody", rg, [
                  og,
                  (_(!0), w(F, null, X(e.parameters, (i) => (_(), w("tr", ig, [
                    h("td", ag, [
                      h("code", {
                        innerHTML: i.name
                      }, null, 8, sg)
...
const Sg = { key: 0 }, kg = { key: 0 }, $g = { class: "columns-1 gap-4 sm:columns-2 2xl:columns-3" }, Pg = ["href"], Eg = ["innerHTML"], Cg = { class: "-mx-4 mt-4 rounded-lg border border-slate-200 dark:border-slate-700" }, jg = ["onClick"], Tg = { class: "ml-2" }, Ag = ["href", "innerHTML"], Ig = ["innerHTML"], Dg = { class: "flex-1 text-right text-xs" }, Ng = { class: "columns-1 p-4 sm:columns-2 2xl:columns-3" }, Lg = ["href"], Mg = ["innerHTML"], Rg = /* @__PURE__ */ D({
  ...
  setup(e) {
    ...
    return (c, p) => $(t) ? (_(), w("div", Sg, [
      (_(!0), w(F, null, X($(t).summary, (f) => (_(), w(F, null, [
        $(r)(f).length ? (_(), w("div", kg, [
          ...
          Nt(h("div", Cg, [
            (_(!0), w(F, null, X($(o)(f), (d) => (_(), w("div", null, [
              h("div", {
                ...
                h("span", Tg, U(d.items.length) + " " + U(f.title.toLowerCase()) + " inherited from ", 1),
                d.url ? (_(), w("a", {
                  key: 0,
                ...
                h("div", Dg, U($(u)(`${f.title}-${d.name}`) ? "Click to collapse" : "Click to expand"), 1)
              ], 8, jg),
              Nt(h("dl", Ng, [
  ...
  enhanceApp(t) {
    ...
    n.component("FlavorTabs", I2), n.component("CodeTabs", R2), n.component("NotFound", rr), n.component("DeviceFrame", K2), n.component("Heading", J2), n.component("ExternalButtonLink", Z2), n.component("StackBlitzLinks", cv), n.component("APIRef", Ev), n.component("APIRefComment", jv), n.component("APIRefHierarchy", Yv), n.component("APIRefParameters", hg), n.component("APIRefSummary", Rg), n.provide("useRouter", Cl), n.provide("useRoute", pn), n.provide(Ts, tf()), n.use(du, {
      instantMove: !0,
      distance: 10,
      themes: {
        tooltip: {
