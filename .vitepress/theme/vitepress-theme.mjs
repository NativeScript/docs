...
import {
  ...
  normalizeClass as Z,
  renderSlot as Re,
  normalizeProps as Al,
  guardReactiveProps as Il,
  withScopeId as Dl,
  resolveComponent as xe,
  ...
  reactive as Hl,
  unref as $,
  getCurrentInstance as Ia,
  getCurrentScope as Fl,
  onScopeDispose as zl,
  shallowRef as Vl,
  isRef as Da,
  withDirectives as Nt,
  renderList as X,
  vModelSelect as Ul,
  withModifiers as wt,
  resolveDynamicComponent as hn,
  vShow as Bn,
  createStaticVNode as Na,
  Transition as yr,
  createTextVNode as Ae,
  resolveDirective as ql,
} from 'vue'
...
async function ir(e, t) {
  t === void 0 && (t = {})
  const { x: n, y: r, platform: o, rects: i, elements: a, strategy: s } = e,
    {
    ...
    d = La(f),
    g = a[p ? (c === 'floating' ? 'reference' : 'floating') : c],
    y = await o.getClippingClientRect({
      element: (await o.isElement(g))
        ? g
        : g.contextElement ||
          (await o.getDocumentElement({
            element: a.floating,
          })),
      boundary: l,
      rootBoundary: u,
...
const Gl = (e) => ({
    ...
    options: e,
    async fn(t) {
      const { element: n, padding: r = 0 } = e != null ? e : {},
        { x: o, y: i, placement: a, rects: s, platform: l } = t
      if (n == null)
        return (
          process.env.NODE_ENV !== 'production' &&
            console.warn(
      ...
      const u = La(r),
        ...
        f = mn(p),
        d = ho(f),
        v = await l.getDimensions({
          element: n,
        }),
        g = f === 'y' ? 'top' : 'left',
        y = f === 'y' ? 'bottom' : 'right',
        b = s.reference[d] + s.reference[f] - c[f] - s.floating[d],
        k = c[f] - s.reference[f],
        S = await l.getOffsetParent({
          element: n,
        }),
        x = S ? (f === 'y' ? S.clientHeight || 0 : S.clientWidth || 0) : 0,
        P = b / 2 - k / 2,
        M = u[g],
        E = x - v[d] - u[y],
        j = x / 2 - v[d] / 2 + P,
...
function Ma(e, t) {
  ...
  return (
    t.reference[o] > t.floating[o] && (i = Hn(i)),
    {
      main: i,
      cross: Hn(i),
    }
...
function ec(e, t, n) {
  return (
    e
      ? [...n.filter((o) => It(o) === e), ...n.filter((o) => It(o) !== e)]
      : n.filter((o) => Xe(o) === o)
  ).filter((o) => (e ? It(o) === e || (t ? Lr(o) !== o : !1) : !0))
}
const tc = function (e) {
  return (
    e === void 0 && (e = {}),
    {
      ...
      async fn(t) {
        var n, r, o, i, a, s
        const { x: l, y: u, rects: c, middlewareData: p, placement: f } = t,
          {
            alignment: d = null,
        ...
        const b = ec(d, g, v),
          k = await ir(t, y),
          S =
            (r = (o = p.autoPlacement) == null ? void 0 : o.index) != null
              ? r
              : 0,
          x = b[S],
          { main: P, cross: M } = Ma(x, c)
        if (f !== x)
          return {
            x: l,
            y: u,
        ...
        const E = [k[Xe(x)], k[P], k[M]],
          j = [
            ...((i = (a = p.autoPlacement) == null ? void 0 : a.overflows) !=
            null
              ? i
              : []),
            {
        ...
        const R = j.slice().sort((Y, W) => Y.overflows[0] - W.overflows[0]),
          H =
            (s = R.find((Y) => {
              let { overflows: W } = Y
    ...
    e === void 0 && (e = {}),
    {
      ...
      async fn(t) {
        ...
        if (
          ...
          var P, M
          const j =
              ((P = (M = i.flip) == null ? void 0 : M.index) != null ? P : 0) +
              1,
            C = b[j]
          if (C)
            return {
...
const ic = function (e) {
  return (
    e === void 0 && (e = 0),
    {
      ...
      options: e,
      fn(t) {
        const { x: n, y: r, placement: o, rects: i } = t,
          a = oc({
            placement: o,
            rects: i,
            value: e,
  ...
  lc = function (e) {
    return (
      e === void 0 && (e = {}),
      {
        ...
        async fn(t) {
          var n
          const { placement: r, rects: o, middlewareData: i } = t,
            { apply: a, ...s } = e
          if ((n = i.size) != null && n.skip) return {}
          const l = await ir(t, s),
            u = Xe(r),
            c = It(r) === 'end'
          let p, f
          u === 'top' || u === 'bottom'
            ...
            b = {
              height:
                ...
                (['left', 'right'].includes(r)
                  ? 2 * (g !== 0 || y !== 0 ? g + y : bt(l.top, l.bottom))
                  : l[p]),
              width:
                o.floating.width -
                (['top', 'bottom'].includes(r)
                  ? 2 * (d !== 0 || v !== 0 ? d + v : bt(l.left, l.right))
                  : l[f]),
            }
          return (
            a == null ||
...
function sr(e) {
  const { overflow: t, overflowX: n, overflowY: r } = ar(e)
...
function Lt(e, t) {
  ...
  return (
    t &&
      Qe(e) &&
      ((r = (e.offsetWidth > 0 && zn(n.width) / e.offsetWidth) || 1),
      (o = (e.offsetHeight > 0 && zn(n.height) / e.offsetHeight) || 1)),
    {
      width: n.width / r,
      height: n.height / o,
      top: n.top / o,
...
function ft(e) {
  return ((cc(e) ? e.ownerDocument : e.document) || window.document)
    .documentElement
}
function lr(e) {
  return mo(e)
...
function Ha(e) {
  return Lt(ft(e)).left + lr(e).scrollLeft
}
function dc(e) {
  const t = Lt(e)
...
function cr(e) {
  return Ge(e) === 'html'
    ? e
    : e.assignedSlot || e.parentNode || (Ra(e) ? e.host : null) || ft(e)
}
function Do(e) {
  return !Qe(e) || getComputedStyle(e).position === 'fixed'
    ? null
    : e.offsetParent
}
function pc(e) {
...
function Mr(e) {
  const t = dt(e)
  let n = Do(e)
  for (; n && uc(n) && getComputedStyle(n).position === 'static'; ) n = Do(n)
  return n &&
    (Ge(n) === 'html' ||
      (Ge(n) === 'body' && getComputedStyle(n).position === 'static' && !Ba(n)))
    ? t
    : n || pc(e) || t
}
function No(e) {
...
function vc(e) {
  ...
  const l = -r.scrollTop
  return (
    ar(o || n).direction === 'rtl' &&
      (s += Yt(n.clientWidth, o ? o.clientWidth : 0) - i),
    {
      width: i,
      height: a,
      x: s,
...
function Vn(e, t) {
  ...
  const r = Fa(e),
    ...
    i = dt(r),
    a = o ? [i].concat(i.visualViewport || [], sr(r) ? r : []) : r,
    s = t.concat(a)
...
function yc(e) {
  const t = Vn(cr(e)),
    r = ['absolute', 'fixed'].includes(ar(e).position) && Qe(e) ? Mr(e) : e
  return Fn(r) ? t.filter((o) => Fn(o) && gc(o, r) && Ge(o) !== 'body') : []
}
function bc(e) {
  let { element: t, boundary: n, rootBoundary: r } = e
  const i = [...(n === 'clippingParents' ? yc(t) : [].concat(n)), r],
    a = i[0],
    s = i.reduce((l, u) => {
      const c = Lo(t, u)
      return (
        (l.top = Yt(c.top, l.top)),
        (l.right = Io(c.right, l.right)),
        (l.bottom = Io(c.bottom, l.bottom)),
...
var Oc = Object.defineProperty,
  ...
  Ro = (e, t, n) =>
    t in e
      ...
      : (e[t] = n),
  qe = (e, t) => {
    for (var n in t || (t = {})) $c.call(t, n) && Ro(e, n, t[n])
    if (Mo) for (var n of Mo(t)) Pc.call(t, n) && Ro(e, n, t[n])
    return e
  },
  vn = (e, t) => Sc(e, kc(t))
function za(e, t) {
  for (const n in t)
    Object.prototype.hasOwnProperty.call(t, n) &&
      (typeof t[n] == 'object' && e[n] ? za(e[n], t[n]) : (e[n] = t[n]))
}
const Ke = {
  disabled: !1,
  distance: 5,
...
function Ec(e) {
  ...
  do
    n.$extend && !n.$resetCss
      ? (t.push(n.$extend), (n = Ke.themes[n.$extend] || {}))
      : (n = null)
  while (n)
...
typeof window < 'u' &&
  typeof navigator < 'u' &&
  (Va = /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream)
const Ua = ['auto', 'top', 'bottom', 'left', 'right'].reduce(
    (e, t) => e.concat([t, `${t}-start`, `${t}-end`]),
    []
  ),
  Ho = {
    ...
    methods: {
        ...
        if (
              ...
              fn: ({ placement: o, rects: i, middlewareData: a }) => {
                ...
                return (
                  o.startsWith('top') || o.startsWith('bottom')
                    ? (s = Math.abs(l) > i.reference.width / 2)
                    : (s = Math.abs(l) > i.reference.height / 2),
                  {
                    data: {
                      overflow: s,
                    },
          ...
          t.middleware.push({
            ...
            fn: ({ rects: i, placement: a, middlewareData: s }) => {
              var l
              if ((l = s.autoSize) != null && l.skip) return {}
              let u, c
              return (
                a.startsWith('top') || a.startsWith('bottom')
                  ? (u = i.reference.width)
                  : (c = i.reference.height),
      ...
      $_scheduleShow(e = null, t = !1) {
        if (
          ...
          vt && this.instantMove && vt.instantMove && vt !== this.parentPopper)
        ) {
          ...
          !this.isShown &&
            ...
            this.positioningDisabled ||
              this.$_registerEventListeners(
                [...Vn(this.$_referenceNode), ...Vn(this.$_popperNode)],
                'scroll',
                () => {
      ...
      async $_applyHide(e = !1) {
        ...
        vt === this && (vt = null),
          ...
          clearTimeout(this.$_disposeTimer)
        const t = Mt(this.theme, 'disposeTimeout')
        t !== null &&
      ...
      $_removeEventListeners(e) {
        ...
        this.$_events.forEach((n) => {
          ...
          !e || e === o
            ? r.forEach((a) => a.removeEventListener(o, i))
            : t.push(n)
        }),
          (this.$_events = t)
      },
      ...
      $_isAimingPopper() {
        ...
        if (Zt >= e.left && Zt <= e.right && Xt >= e.top && Xt <= e.bottom) {
          const t = this.$_popperNode.getBoundingClientRect(),
            ...
            s = it + r * i
          return (
            wn(ot, it, a, s, t.left, t.top, t.left, t.bottom) ||
            wn(ot, it, a, s, t.left, t.top, t.right, t.top) ||
            wn(ot, it, a, s, t.right, t.top, t.right, t.bottom) ||
            wn(ot, it, a, s, t.left, t.bottom, t.right, t.bottom)
          )
        }
        return !1
      },
...
typeof document < 'u' &&
  ...
  (Va
    ...
    : (window.addEventListener('mousedown', qo, !0),
      window.addEventListener('click', Cc, !0)),
        ...
        requestAnimationFrame(() => {
          if (((o.$_pendingHide = !1), !n[o.randomId] && Wo(o, i, e))) {
            if (
              ...
              for (; s; ) (n[s.randomId] = !0), (s = s.parentPopper)
              return
            }
...
function Ic(e) {
  for (let t = 0; t < Le.length; t++) Le[t].$_computePosition(e)
}
let ot = 0,
  it = 0,
  Zt = 0,
...
function Nc(e, t, n, r, o, i) {
  return (
    ...
    w(
      ...
      [Re(e.$slots, 'default', Al(Il(e.slotData)))],
      2
    )
  )
}
...
const Fc = D({
  ...
  zc = ['id', 'aria-hidden', 'tabindex', 'data-popper-placement'],
  Vc = {
    ref: 'inner',
    class: 'v-popper__inner',
  },
  Uc = /* @__PURE__ */ h('div', { class: 'v-popper__arrow-outer' }, null, -1),
  qc = /* @__PURE__ */ h('div', { class: 'v-popper__arrow-inner' }, null, -1),
  Wc = [Uc, qc]
  ...
  return (
    ...
    w(
      'div',
      {
        ...
        onKeyup:
          t[2] || (t[2] = Nl((s) => e.autoHide && e.$emit('hide'), ['esc'])),
      },
      [
        h('div', {
...
var Ja = /* @__PURE__ */ ur(Fc, [['render', Kc]]),
  Ga = {
    methods: {
      show(...e) {
...
function ou(e, t) {
  let n = e.placement
  if (!n && t) for (const r of Ua) t[r] && (n = r)
  return n || (n = Mt(e.theme || 'tooltip', 'placement')), n
}
function Ya(e, t, n) {
  let r
  const o = typeof t
...
function su(e, t, n) {
  ...
  return (
    on.value.push(i),
    e.classList && e.classList.add(Qa),
    (e.$_popper = {
      options: r,
      item: i,
      show() {
...
function Ko(e, { value: t, modifiers: n }) {
  const r = Ya(e, t, n)
  if (!r.content || Mt(r.theme || 'tooltip', 'disabled')) Za(e)
  else {
    let o
    e.$_popper ? ((o = e.$_popper), (o.options.value = r)) : (o = su(e, t, n)),
      typeof t.shown < 'u' &&
...
function Go(e) {
  e.removeEventListener('click', Xa),
    e.removeEventListener('touchstart', es),
    e.removeEventListener('touchend', ts),
    e.removeEventListener('touchcancel', ns)
}
function Xa(e) {
...
function es(e) {
  if (e.changedTouches.length === 1) {
    ...
    ;(t.$_vclosepopover_touchPoint = n),
      t.addEventListener('touchend', ts),
      t.addEventListener('touchcancel', ns)
  }
}
function ts(e) {
  const t = e.currentTarget
...
function uu(e, t = {}) {
  e.$_vTooltipInstalled ||
    ...
    za(Ke, t),
    e.directive('tooltip', lu),
    e.directive('close-popper', cu),
    e.component('VTooltip', Zc),
    e.component('VDropdown', Qc),
    e.component('VMenu', Yc))
}
const du = {
...
function be({
  ...
  var i
  let a = fu(r, n),
    s = Object.assign(o, { props: a })
  if (e || (t & 2 && a.static)) return Or(s)
  if (t & 1) {
...
function Or({ props: e, attrs: t, slots: n, slot: r, name: o }) {
  var i
  let { as: a, ...s } = go(e, ['unmount', 'static']),
...
function yu(e, t) {
  ...
  return (
    ...
    Oe(() => {
      ...
      n.value ||
        !Ie(t) ||
        (Ie(t) instanceof HTMLButtonElement &&
          !((r = Ie(t)) != null && r.hasAttribute('type')) &&
          (n.value = 'button'))
    }),
    n
  )
...
function xu(e, t = 0) {
  var n
  return e === ((n = Rt(e)) == null ? void 0 : n.body)
    ? !1
    : Me(t, {
        [0]() {
          return e.matches(Hr)
...
function Su(e) {
  var t, n
  return (n =
    (t = e == null ? void 0 : e.matches) == null ? void 0 : t.call(e, Ou)) !=
    null
    ? n
    : !1
}
...
function Fr(e, t, n = !0, r = null) {
  ...
  let i =
      (o = Array.isArray(e)
        ...
        ? o
        : document,
    a = Array.isArray(e) ? (n ? ku(e) : e) : wu(e)
...
function $u(e, t, n = A(() => !0)) {
  ...
  Sr(
    ...
    (i) => {
      ...
      n.value &&
        (o.value =
          ((s = (a = i.composedPath) == null ? void 0 : a.call(i)) == null
            ? void 0
            : s[0]) || i.target)
    },
    !0
  ...
  if (n) {
    for (let r of n.elements)
      if (
        ...
        (r.tagName === 'BUTTON' && r.type === 'submit') ||
        (r.nodeName === 'INPUT' && r.type === 'image')
      ) {
        r.click()
        return
      }
...
function Eu(e, t, n) {
  let r = T(n == null ? void 0 : n.value),
    o = A(() => e.value !== void 0)
  return [
    A(() => (o.value ? e.value : r.value)),
    function (i) {
...
let Vt = Object.assign(
  D({
    ...
    props: {
      ...
      containers: { type: Object, default: T(/* @__PURE__ */ new Set()) },
    },
    inheritAttrs: !1,
    setup(e, { attrs: t, slots: n, expose: r }) {
      ...
      Au(
        { ownerDocument: i },
        A(() => Boolean(e.features & 16))
      )
      let a = Iu(
        {
          ownerDocument: i,
          container: o,
          initialFocus: A(() => e.initialFocus),
        },
        A(() => Boolean(e.features & 2))
      )
      Du(
        {
          ownerDocument: i,
      ...
      function l() {
        ...
        !u ||
          Me(s.value, {
            [zr.Forwards]: () => Fr(u, an.First),
            [zr.Backwards]: () => Fr(u, an.Last),
          })
      }
      return () => {
        let u = {},
          c = { ref: o },
          { features: p, initialFocus: f, containers: d, ...v } = e
        return fe(F, [
          Boolean(p & 4) &&
            fe(Wn, {
              as: 'button',
        ...
        (a, s) => {
          ...
          !l ||
            Tu(() => {
              ...
              p
                ? en(p)
                : Fr(l, an.First | an.NoScroll) === is.Error &&
                  console.warn(
...
function Du(
  ...
  var i
  ss(
    (i = e.value) == null ? void 0 : i.defaultView,
    'focus',
    (a) => {
      if (!o.value) return
      ...
      u && u instanceof HTMLElement
        ? Nu(s, u)
          ? ((r.value = u), en(u))
          : (a.preventDefault(), a.stopPropagation(), en(l))
        : en(r.value)
    },
    !0
  )
...
function Lu(e, t = T(!0)) {
  Oe((n) => {
    ...
    if (o) {
      kt.add(r)
      for (let i of at.keys()) i.contains(r) && (Xo(i), at.delete(i))
      o.querySelectorAll(Yo).forEach((i) => {
        if (i instanceof HTMLElement) {
          for (let a of kt) if (i.contains(a)) return
          kt.size === 1 &&
            (at.set(i, {
        ...
        n(() => {
          ...
          else for (let i of at.keys()) Xo(i), at.delete(i)
        })
    }
  })
}
...
let us = D({
    ...
    setup(e, { slots: t, attrs: n }) {
      let r = T(null),
        ...
        i = Mu(),
        a = he(ds, null),
        s = T(i === !0 || a == null ? Ru(r.value) : a.resolveTarget())
      return (
        Oe(() => {
        ...
        Ze(() => {
          ...
          !c ||
            (s.value === c &&
              ...
              ((u = s.value.parentElement) == null || u.removeChild(s.value)))
        }),
        () => {
...
var Ur = ((e) => ((e[(e.Add = 0)] = 'Add'), (e[(e.Remove = 1)] = 'Remove'), e))(
  Ur || {}
)
function Hu() {
  return he(fs, () => {})
...
function hs({ slot: e = T({}), name: t = 'Description', props: n = {} } = {}) {
  ...
  return (
    Be(ps, { register: o, slot: e, name: t, props: n }),
    A(() => (r.value.length > 0 ? r.value.join(' ') : void 0))
  )
}
let Fg = D({
  name: 'Description',
  ...
  setup(e, { attrs: t, slots: n }) {
    let r = zu(),
      o = `headlessui-description-${et()}`
    return (
      se(() => Ze(r.register(o))),
      () => {
        let { name: i = 'Description', slot: a = T({}), props: s = {} } = r,
          l = e,
          u = {
            ...Object.entries(s).reduce(
              (c, [p, f]) => Object.assign(c, { [p]: $(f) }),
              {}
            ),
            id: o,
          }
    ...
    n = {
      ...
      addEventListener(r, o, i, a) {
        return (
          ...
          n.add(() => r.removeEventListener(o, i, a))
        )
      },
...
let xn = 'DC8F892D-2EBD-447C-A4C8-A03058436FF4',
  qu = D({
    name: 'Dialog',
    inheritAttrs: !1,
    props: {
      ...
      open: { type: [Boolean, String], default: xn },
      initialFocus: { type: Object, default: null },
    },
    emits: { close: (e) => !0 },
    setup(e, { emit: t, attrs: n, slots: r, expose: o }) {
      ...
      let s = T(0),
        ...
        u = A(() =>
          e.open === xn && l !== null
            ? Me(l.value, { [Ot.Open]: !0, [Ot.Closed]: !1 })
            : e.open
        ),
      ...
      if (typeof u.value != 'boolean')
        throw new Error(
          `You provided an \`open\` prop to the \`Dialog\`, but the value is not a boolean. Received: ${
            u.value === xn ? void 0 : e.open
          }`
        )
      let v = A(() => (a.value && u.value ? 0 : 1)),
        g = A(() => v.value === 0),
        y = A(() => s.value > 1),
        b = he(qr, null) !== null,
        k = A(() => (y.value ? 'parent' : 'leaf'))
      Lu(
        p,
        A(() => (y.value ? g.value : !1))
      ),
      ...
      return (
              ...
              ...Array.from(
                ...
                (R) =>
                  !(
                    ...
                    R.contains(Ie(f)) ||
                    (M.panelRef.value && R.contains(M.panelRef.value))
                  )
              ),
              (C = M.panelRef.value) != null ? C : p.value,
            ]
          },
          (E, j) => {
        ...
        ss((i = d.value) == null ? void 0 : i.defaultView, 'keydown', (E) => {
          E.defaultPrevented ||
            (E.key === qn.Escape &&
              v.value === 0 &&
              (y.value || (E.preventDefault(), E.stopPropagation(), M.close())))
        }),
        Oe((E) => {
          var j
          if (v.value !== 0 || b) return
          let C = d.value
          if (!C) return
          let R = yo()
          function H(ee, le, He) {
            ...
            return (
              Object.assign(ee.style, { [le]: He }),
              R.add(() => {
                Object.assign(ee.style, { [le]: Ce })
              })
            )
          }
          let Y = C == null ? void 0 : C.documentElement,
            W =
              ((j = C.defaultView) != null ? j : window).innerWidth -
              Y.clientWidth
          if ((H(Y, 'overflow', 'hidden'), W > 0)) {
            let ee = Y.clientWidth - Y.offsetWidth,
              le = W - ee
        ...
        () => {
          let E = {
            ...
            { open: j, initialFocus: C, ...R } = e,
            H = { open: v.value === 0 }
          return fe(Vr, { force: !0 }, () => [
            fe(us, () =>
              fe(Bu, { target: p.value }, () =>
                fe(Vr, { force: !1 }, () =>
                  fe(
                    Vt,
                    {
                      ...
                      features: g.value
                        ? Me(k.value, {
                            parent: Vt.features.RestoreFocus,
                            leaf: Vt.features.All & ~Vt.features.FocusLock,
                          })
                        : Vt.features.None,
                    },
                    () =>
                      be({
                        ...
                        slots: r,
                        visible: v.value === 0,
                        features: Un.RenderStrategy | Un.Static,
                        name: 'Dialog',
                      })
                  )
                )
...
D({
  ...
  props: { as: { type: [Object, String], default: 'div' } },
  setup(e, { attrs: t, slots: n }) {
    let r = gn('DialogOverlay'),
      o = `headlessui-dialog-overlay-${et()}`
    function i(a) {
      a.target === a.currentTarget &&
        (a.preventDefault(), a.stopPropagation(), r.close())
    }
    return () =>
      be({
...
D({
  ...
  inheritAttrs: !1,
  setup(e, { attrs: t, slots: n, expose: r }) {
    let o = gn('DialogBackdrop'),
      i = `headlessui-dialog-backdrop-${et()}`,
      a = T(null)
    return (
      r({ el: a, $el: a }),
      se(() => {
...
let Wu = D({
  ...
  props: { as: { type: [Object, String], default: 'div' } },
  setup(e, { attrs: t, slots: n, expose: r }) {
    let o = gn('DialogPanel'),
      i = `headlessui-dialog-panel-${et()}`
...
D({
  ...
  setup(e, { attrs: t, slots: n }) {
    let r = gn('DialogTitle'),
      o = `headlessui-dialog-title-${et()}`
    return (
      se(() => {
...
function Ku({ slot: e = {}, name: t = 'Label', props: n = {} } = {}) {
  ...
  return (
    Be(ms, { register: o, slot: e, name: t, props: n }),
    A(() => (r.value.length > 0 ? r.value.join(' ') : void 0))
  )
}
let zg = D({
    ...
    setup(e, { slots: t, attrs: n }) {
      let r = vs(),
        o = `headlessui-label-${et()}`
      return (
        se(() => Ze(r.register(o))),
        () => {
          let { name: i = 'Label', slot: a = {}, props: s = {} } = r,
            { passive: l, ...u } = e,
            c = {
              ...Object.entries(s).reduce(
                (p, [f, d]) => Object.assign(p, { [f]: $(d) }),
                {}
              ),
              id: o,
            }
          return (
            l && (delete c.onClick, delete u.onClick),
            be({
              ourProps: c,
              theirProps: u,
              slot: a,
...
D({
  ...
  setup(e, { slots: t, attrs: n }) {
    ...
    return (
      Be(gs, { switchRef: r, labelledby: o, describedby: i }),
      () =>
        be({
          theirProps: e,
          ourProps: {},
...
let Ju = D({
  ...
  setup(e, { emit: t, attrs: n, slots: r, expose: o }) {
    let i = he(gs, null),
      a = `headlessui-switch-${et()}`,
      [s, l] = Eu(
        A(() => e.modelValue),
        (y) => t('update:modelValue', y),
        A(() => e.defaultChecked)
      )
    function u() {
      l(!s.value)
    ...
    let c = T(null),
      p = i === null ? c : i.switchRef,
      f = yu(
        A(() => ({ as: e.as, type: n.type })),
        p
      )
    o({ el: p, $el: p })
    function d(y) {
    ...
    function v(y) {
      y.key === qn.Space
        ? (y.preventDefault(), u())
        : y.key === qn.Enter && Pu(y.currentTarget)
    }
    function g(y) {
      y.preventDefault()
    }
    return () => {
      let { name: y, value: b, ...k } = e,
        S = { checked: s.value },
        x = {
          id: a,
          ref: p,
      ...
      return fe(F, [
        ...
        be({
          ourProps: x,
          theirProps: { ...n, ...go(k, ['modelValue', 'defaultChecked']) },
          slot: S,
          attrs: n,
          slots: r,
          name: 'Switch',
...
var Wr = ((e) => ((e.Finished = 'finished'), (e.Cancelled = 'cancelled'), e))(
  Wr || {}
)
function Qu(e, t) {
  let n = yo()
  ...
  return (
    i !== 0 ? n.setTimeout(() => t('finished'), i + a) : t('finished'),
    n.add(() => t('cancelled')),
    n.dispose
  )
}
function ei(e, t, n, r, o, i) {
  ...
  return (
    ...
    a.nextFrame(() => {
      On(e, ...n),
        kr(e, ...r),
        a.add(Qu(e, (l) => (On(e, ...r, ...t), kr(e, ...o), s(l))))
    }),
    a.add(() => On(e, ...t, ...n, ...r, ...o)),
    a.add(() => s('cancelled')),
    a.dispose
...
function _s(e) {
  ...
  function o(i) {
    ...
    return (
      a
        ? a.state !== 'visible' && (a.state = 'visible')
        : t.value.push({ id: i, state: 'visible' }),
      () => r(i, st.Unmount)
    )
  }
  return { children: t, register: o, unregister: r }
}
let ys = Un.RenderStrategy,
  Kr = D({
    props: {
      as: { type: [Object, String], default: 'div' },
    ...
    setup(e, { emit: t, attrs: n, slots: r, expose: o }) {
      ...
      let i = T(null),
        a = T('visible'),
        s = A(() => (e.unmount ? st.Unmount : st.Hidden))
      o({ el: i, $el: i })
      let { show: l, appear: u } = Xu(),
        { register: c, unregister: p } = ed(),
        f = { value: !0 },
        d = et(),
        v = { value: !1 },
        g = _s(() => {
      ...
      se(() => {
        ...
        Oe(() => {
          if (s.value === st.Hidden && !!d) {
            ...
            Me(a.value, { hidden: () => p(d), visible: () => c(d) })
          }
        })
      let y = gt(e.enter),
        b = gt(e.enterFrom),
      ...
      function E(j) {
        let C = f.value && !u.value,
          R = Ie(i)
        !R ||
          !(R instanceof HTMLElement) ||
          C ||
          ((v.value = !0),
          l.value && t('beforeEnter'),
          l.value || t('beforeLeave'),
          j(
            l.value
              ? ei(R, y, b, k, S, (H) => {
              ...
              : ei(R, x, P, M, S, (H) => {
                  ;(v.value = !1),
                    H === Wr.Finished &&
                      (pr(g) || ((a.value = 'hidden'), p(d), t('afterLeave')))
                })
          ))
      }
      return (
        ...
        Be(wo, g),
        _u(A(() => Me(a.value, { visible: Ot.Open, hidden: Ot.Closed }))),
        () => {
          let {
            appear: j,
            show: C,
  ...
  bs = D({
    ...
    setup(e, { emit: t, attrs: n, slots: r }) {
      let o = _o(),
        i = A(() =>
          e.show === null && o !== null
            ? Me(o.value, { [Ot.Open]: !0, [Ot.Closed]: !1 })
            : e.show
        )
      Oe(() => {
      ...
      let a = T(i.value ? 'visible' : 'hidden'),
        s = _s(() => {
          a.value = 'hidden'
        }),
        l = T(!0),
        u = { show: i, appear: A(() => e.appear || !l.value) }
      return (
        se(() => {
          Oe(() => {
            ;(l.value = !1),
              i.value ? (a.value = 'visible') : pr(s) || (a.value = 'hidden')
          })
        }),
        Be(wo, s),
        Be(bo, u),
...
var ni = Object.getOwnPropertySymbols,
  ...
  dd = (e, t) => {
    var n = {}
    for (var r in e) cd.call(e, r) && t.indexOf(r) < 0 && (n[r] = e[r])
    if (e != null && ni)
      for (var r of ni(e)) t.indexOf(r) < 0 && ud.call(e, r) && (n[r] = e[r])
    return n
  }
function fd(e, t, n = {}) {
  const r = n,
...
var pd = Object.defineProperty,
  ...
  ri = (e, t, n) =>
    t in e
      ...
      : (e[t] = n),
  vd = (e, t) => {
    for (var n in t || (t = {})) ks.call(t, n) && ri(e, n, t[n])
    if (Kn) for (var n of Kn(t)) $s.call(t, n) && ri(e, n, t[n])
    return e
  },
  gd = (e, t) => hd(e, md(t)),
  _d = (e, t) => {
    ...
    if (e != null && Kn)
      for (var r of Kn(e)) t.indexOf(r) < 0 && $s.call(e, r) && (n[r] = e[r])
    return n
  }
function yd(e, t, n = {}) {
  const r = n,
...
function Ps(...e) {
  ...
  const i = [],
    ...
    s = (c, p, f) => (
      c.addEventListener(p, f, o), () => c.removeEventListener(p, f, o)
    ),
    l = $e(
      () => bd(t),
      (c) => {
...
function xd(e, t = {}) {
  const { window: n = lt } = t,
    r = wd(() => n && 'matchMedia' in n && typeof n.matchMedia == 'function')
  let o
  const i = T(!1),
    a = () => {
      !o ||
...
var kd = Object.defineProperty,
  ...
  ii = (e, t, n) =>
    t in e
      ...
      : (e[t] = n),
  ai = (e, t) => {
    for (var n in t || (t = {})) $d.call(t, n) && ii(e, n, t[n])
    if (oi) for (var n of oi(t)) Pd.call(t, n) && ii(e, n, t[n])
    return e
  }
const Ed = {
  boolean: {
...
function Cs(e, t, n, r = {}) {
  ...
  const g = ws(t),
    y = Sd(g),
    b = (o = r.serializer) != null ? o : Ed[y],
    { pause: k, resume: S } = yd(v, () => x(v.value), {
      flush: i,
      deep: a,
      eventFilter: f,
    })
  ...
  function P(E) {
    ...
    try {
      ...
      if (j == null) return l && g !== null && n.setItem(e, b.write(g)), g
      if (!E && u) {
        const C = b.read(j)
        return nd(u)
          ? u(C, g)
          : y === 'object' && !Array.isArray(C)
          ? ai(ai({}, g), C)
          : C
      } else return typeof j != 'string' ? j : b.read(j)
    } catch (j) {
      d(j)
    } finally {
      S()
...
var Cd = Object.defineProperty,
  ...
  li = (e, t, n) =>
    t in e
      ...
      : (e[t] = n),
  Ad = (e, t) => {
    for (var n in t || (t = {})) jd.call(t, n) && li(e, n, t[n])
    if (si) for (var n of si(t)) Td.call(t, n) && li(e, n, t[n])
    return e
  }
function Id(e = {}) {
  const {
    ...
    p = js({ window: o }),
    f = A(() => (p.value ? 'dark' : 'light')),
    d =
      l ||
      (a == null
        ? T(r)
        : Cs(a, r, i, { window: o, listenToStorageChanges: s })),
    v = A({
      get() {
  ...
  return (
    $e(v, b, { flush: 'post', immediate: !0 }),
    u && $e(f, () => b(v.value), { flush: 'post' }),
    Ss(() => b(v.value)),
    v
  )
}
var Dd = Object.defineProperty,
  ...
  ui = (e, t, n) =>
    t in e
      ...
      : (e[t] = n),
  Bd = (e, t) => {
    for (var n in t || (t = {})) Md.call(t, n) && ui(e, n, t[n])
    if (ci) for (var n of ci(t)) Rd.call(t, n) && ui(e, n, t[n])
    return e
  },
  Hd = (e, t) => Nd(e, Ld(t))
function Fd(e = {}) {
  const { valueDark: t = 'dark', valueLight: n = '', window: r = lt } = e,
    o = Id(
      Hd(Bd({}, e), {
        onChanged: (s, l) => {
          var u
          e.onChanged
            ? (u = e.onChanged) == null || u.call(e, s === 'dark')
            : l(s)
        },
        modes: {
          dark: t,
...
var Vd = Object.defineProperty,
  ...
  pi = (e, t, n) =>
    t in e
      ...
      : (e[t] = n),
  Wd = (e, t) => {
    for (var n in t || (t = {})) Ud.call(t, n) && pi(e, n, t[n])
    if (fi) for (var n of fi(t)) qd.call(t, n) && pi(e, n, t[n])
    return e
  }
const Kd = {
...
const $t = Fd(),
  Gd = /* @__PURE__ */ h('span', { class: 'sr-only' }, 'Toggle Dark Mode', -1),
  Qd = /* @__PURE__ */ h(
    'svg',
    {
  ...
  Ts = Symbol(),
  hi = '__CURRENT_FLAVOR__'
function tf() {
  var n
  const e = zd(hi, ''),
    t = T((n = e.value) != null ? n : void 0)
  return (
    $e(t, () => {
...
function As() {
  const e = he(Ts)
  if (!e) throw new Error('useCurrentFlavor() is called without provider.')
  return e
}
const nf = { class: 'relative flex items-center' },
  rf = ['value'],
  of = /* @__PURE__ */ D({
    __name: 'FlavorDropdown',
    setup(e) {
      const { value: t, set: n } = As(),
        r = [
              ...
              default: pe(() => [
                Nt(
                  h(
                    ...
                    {
                      class:
                        'form-select w-full rounded border border-slate-200 bg-slate-100 px-4 py-2 dark:border-white/20 dark:bg-white/10 dark:text-white',
                      'onUpdate:modelValue':
                        a[0] || (a[0] = (l) => (Da(o) ? (o.value = l) : null)),
                    },
                    [
                      (_(!0),
                      w(
...
const Is = /#.*$/,
  sf = /(index)?\.(md|html)$/,
  lf = typeof window < 'u',
  cf = T(lf ? location.hash : '')
function St(e, t, n = !1) {
  if (t === void 0) return !1
  if (((e = mi(`/${e}`)), n)) return new RegExp(t).test(e)
  if (mi(t) !== e) return !1
  const r = t.match(Is)
...
function yn() {
  ...
  return A(() => {
    var i, a
    const o =
      (i = Object.keys(n.sidebar).find((s) =>
        St(t.value.relativePath, s, !0)
      )) != null
        ? i
        : '/'
...
function xo(e) {
  ...
  for (const r of e) n(r.items, r)
  return t
}
const df = {
    key: 0,
    class:
      'flex w-full items-center gap-x-3 rounded-md p-2 text-left text-sm font-semibold leading-6 text-gray-700 dark:text-white',
  },
  ff = { key: 1 },
  pf = ['href'],
  hf = {
                      ...
                      'a',
                      {
                        ...
                        class: Z([
                          ...
                          $(St)(
                            ...
                            ? 'font-semibold text-blue-700 dark:text-cyan-400'
  ...
  vf = {
    class:
      'sticky top-0 dark:-top-px z-10 border-b dark:border-t bg-gray-50 px-4 py-2 dark:border-white/10 dark:bg-gray-900 lg:hidden',
  },
  gf = /* @__PURE__ */ h('span', { class: 'ml-2 text-xs' }, 'Menu', -1),
  _f = { class: 'fixed inset-0 overflow-hidden' },
  yf = { class: 'absolute inset-0 overflow-hidden' },
  bf = {
    class: 'pointer-events-none fixed inset-y-0 left-0 flex max-w-full pr-24',
  },
  wf = {
    class:
      'flex h-full flex-col overflow-y-scroll bg-white py-6 shadow-xl dark:bg-gray-900 dark:shadow-cyan-400/20',
  },
  xf = { class: 'relative flex-1 px-4 sm:px-6' },
  Of = {
    role: 'list',
    class: 'space-y-1',
  },
          ...
          [
            h('div', vf, [
              h(
                ...
                [
                  B($(af), {
                    class: 'h-5 w-5 text-gray-400 dark:text-white/50',
                  }),
                  gf,
                ]
              ),
                    ...
                    },
                    {
                      default: pe(() => [
                        B($(Kr), {
                          as: 'div',
                          class:
                            'fixed inset-0 bg-gray-200/80 dark:bg-gray-900/70',
...
const jf = /* @__PURE__ */ Bt(kf, [['render', Cf]]),
  Tf = {},
  Af = {
    xmlns: 'http://www.w3.org/2000/svg',
    fill: 'none',
...
const Lf = /* @__PURE__ */ Bt(Tf, [['render', Nf]]),
  Mf = {},
  Rf = {
    xmlns: 'http://www.w3.org/2000/svg',
    fill: 'none',
...
const zf = /* @__PURE__ */ Bt(Mf, [['render', Ff]]),
  Vf = {},
  Uf = {
    xmlns: 'http://www.w3.org/2000/svg',
    viewBox: '0 0 20 20',
...
const In = /* @__PURE__ */ Bt(Vf, [['render', Kf]]),
  Jf = {
    key: 0,
    class: 'mt-4',
  },
  Gf = ['innerHTML'],
  Qf = ['href', 'data-current'],
  Yf = { class: 'flex items-center' },
  Zf = ['innerHTML'],
  Xf = /* @__PURE__ */ D({
    __name: 'SideBarLink',
    props: {
    ...
    setup(e) {
      const t = e,
        ...
        { page: r, site: o } = De(),
        i = t.item.text,
        a = p(o.value.base, t.item.link),
        s = t.item.items,
        l = A(() => St(r.value.relativePath, t.item.link)),
        u = t.item.icon && n[t.item.icon],
        c = T(!!t.item.hideChildren)
      function p(f, d) {
                ...
                ? (_(),
                  w(
                    'p',
                    {
                      ...
                      onClick:
                        d[0] ||
                        (d[0] = wt((k) => (c.value = !c.value), ['prevent'])),
                      class:
                        'group mt-6 flex cursor-pointer items-center justify-between py-2 text-sm font-semibold tracking-wide text-slate-900 dark:text-white',
                    },
                    [
                      h('span', { innerHTML: $(i) }, null, 8, Gf),
                      ((y = e.item) == null ? void 0 : y.collapsible) !== !1
                        ? (_(),
                          ce(
                            In,
                            {
                              key: 0,
                              class: Z([
                                'h-5 w-5 text-slate-400 group-hover:text-slate-800 dark:group-hover:text-cyan-300',
                                {
                    ...
                    [
                      h('div', Yf, [
                        h(
                          ...
                          {
                            class: Z([
                              'absolute left-0.5 h-1.5 w-1.5 rounded-full',
                              {
                      ...
                      $(s) &&
                      ((b = e.item) == null ? void 0 : b.collapsible) !== !1
                        ? (_(),
                          w(
                            'button',
                            {
                            ...
                            [
                              B(
                                ...
                                {
                                  class: Z([
                                    'h-5 w-5 text-slate-400 hover:text-slate-800 dark:hover:text-cyan-300',
                                    {
                                      'rotate-90 transform': !c.value,
                                    },
                                  ]),
...
var jp = function (t, n) {
  ...
  Lp = $p,
  Mp = jp
const Rp = { class: 'space-y-3' },
  Bp = ['href'],
  Hp = {
    key: 0,
    class:
      'rounded border border-slate-300 p-1 text-slate-400 dark:border-slate-300/30 dark:text-slate-300/40',
  },
  Fp = { class: 'ml-3 font-medium leading-6 tracking-wide' },
  zp = /* @__PURE__ */ D({
    __name: 'SideBarNav',
    setup(e) {
      const t = {
                ...
                w('li', null, [
                  h(
                    'a',
                    {
                      ...
                      class: Z([
                        'flex items-center',
                        $(St)($(r).relativePath, a.activeMatch, !!a.activeMatch)
  ...
  Ut = (e = '') =>
    ({ BASE_URL: '/', MODE: 'production', DEV: !1, PROD: !0 }.VITE_MAIN_URL +
    e),
  Vp = (e = '') =>
    ({ BASE_URL: '/', MODE: 'production', DEV: !1, PROD: !0 }.VITE_DOCS_URL +
    e),
  Up = (e = '') =>
    ({ BASE_URL: '/', MODE: 'production', DEV: !1, PROD: !0 }.VITE_BLOG_URL +
    e),
  vi = {
    nav: [
      { text: 'Docs', link: Vp() },
    ...
    flyoutNav: [
      ...
      },
      {
        ...
        link: Ut('/samples'),
        description:
          'Browse creative samples of NativeScript user experiences.',
      },
      {
        text: 'Showcase',
        link: Ut('/showcase'),
      ...
      },
      {
        ...
        target: 'blank',
        description:
          'Preview NativeScript projects with StackBlitz or locally.',
      },
      {
        text: 'Governance',
  ...
  gi = /* @__PURE__ */ D({
    ...
    setup(e) {
      return (t, n) =>
        e.variant === 'blue' ? (_(), w('svg', qp, Kp)) : (_(), w('svg', Jp, Qp))
    },
  })
...
function Q(e) {
  for (var t = 1; t < arguments.length; t++) {
    ...
    t % 2
      ...
      : _i(Object(n)).forEach(function (r) {
...
var N,
  ...
  Qn = {},
  Oo = [],
  Xp = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i
function We(e, t) {
...
function cn(e, t) {
  if (t == null) return e.__ ? cn(e.__, e.__.__k.indexOf(e) + 1) : null
...
function Zr(e) {
  ;((!e.__d && (e.__d = !0) && tn.push(e) && !Yn.__r++) ||
    yi !== N.debounceRendering) &&
    ((yi = N.debounceRendering) || Ns)(Yn)
}
function Yn() {
    ...
    if (
      (d = n.__k[c] =
        (d = t[c]) == null || typeof d == 'boolean'
          ...
          ? nn(null, d, null, null, d)
          : Array.isArray(d)
          ? nn(ct, { children: d }, null, null, null)
          : d.__b > 0
          ? nn(d.type, d.props, d.key, null, d.__v)
          : d) != null
    ) {
      if (
        ((d.__ = n),
        (d.__b = n.__b + 1),
        (f = b[c]) === null || (f && d.key == f.key && d.type === f.type))
      )
        b[c] = void 0
      else
        for (p = 0; p < k; p++) {
      ...
      So(e, d, (f = f || Qn), o, i, a, s, l, u),
        ...
        v != null
          ? (g == null && (g = v),
            typeof d.type == 'function' && d.__k != null && d.__k === f.__k
              ? (d.__d = l = Hs(d, l, e))
              : (l = Fs(e, d, f, b, v, l)),
            u || n.type !== 'option'
              ? typeof n.type == 'function' && (n.__d = l)
              : (e.value = ''))
          : l && f.__e == l && l.parentNode != e && (l = cn(f))
    }
  for (n.__e = g, c = k; c--; )
    b[c] != null &&
      (typeof n.type == 'function' &&
        ...
        (n.__d = cn(r, c + 1)),
      Us(b[c], b[c]))
  if (y) for (c = 0; c < y.length; c++) Vs(y[c], y[++c], y[++c])
}
function Hs(e, t, n) {
  var r, o
...
function bi(e, t, n) {
  t[0] === '-'
    ? e.setProperty(t, n)
    : (e[t] =
        n == null ? '' : typeof n != 'number' || Xp.test(t) ? n : n + 'px')
}
  ...
  e: if (t === 'style')
    if (typeof n == 'string') e.style.cssText = n
      ...
      if ((typeof r == 'string' && (e.style.cssText = r = ''), r))
        for (t in r) (n && t in n) || bi(e.style, t, '')
      if (n) for (t in n) (r && n[t] === r[t]) || bi(e.style, t, n[t])
    }
  else if (t[0] === 'o' && t[1] === 'n')
    (i = t !== (t = t.replace(/Capture$/, ''))),
      ...
      (e.l[t + i] = n),
      n
        ? r || e.addEventListener(t, i ? xi : wi, i)
        : e.removeEventListener(t, i ? xi : wi, i)
...
function So(e, t, n, r, o, i, a, s, l) {
  ...
  try {
    e: if (typeof x == 'function') {
      if (
        ((y = t.props),
        (b = (u = x.contextType) && r[u.__c]),
        (k = u ? (b ? b.props.value : u.__) : r),
        n.__c
        ...
        x.getDerivedStateFromProps != null &&
          (c.__s == c.state && (c.__s = We({}, c.__s)),
          We(c.__s, x.getDerivedStateFromProps(y, c.__s))),
        (f = c.props),
        (d = c.state),
        p)
      )
        ...
        if (
          (x.getDerivedStateFromProps == null &&
            ...
            c.componentWillReceiveProps(y, k),
          (!c.__e &&
            c.shouldComponentUpdate != null &&
            c.shouldComponentUpdate(y, c.__s, k) === !1) ||
            t.__v === n.__v)
        ) {
          ;(c.props = y),
            (c.state = c.__s),
        ...
        c.componentWillUpdate != null && c.componentWillUpdate(y, c.__s, k),
      ...
      ;(c.context = k),
        ...
        (c.state = c.__s),
        c.getChildContext != null && (r = We(We({}, r), c.getChildContext())),
        p ||
          c.getSnapshotBeforeUpdate == null ||
          (v = c.getSnapshotBeforeUpdate(f, d)),
        (S =
          u != null && u.type === ct && u.key == null ? u.props.children : u),
        Bs(e, Array.isArray(S) ? S : [S], t, n, r, o, i, a, s, l),
        (c.base = t.__e),
        (t.__h = null),
        c.__h.length && a.push(c),
        g && (c.__E = c.__ = null),
...
function eh(e, t, n, r, o, i, a, s) {
  ...
  if (v === null) f === d || (s && e.data === d) || (e.data = d)
  else {
    if (
      ((i = i && Oo.slice.call(e.childNodes)),
      (u = (f = n.props || Qn).dangerouslySetInnerHTML),
    ...
    if (
      ...
      for (g = i.length; g--; ) i[g] != null && Ms(i[g])
    s ||
      ('value' in d &&
        (g = d.value) !== void 0 &&
        (g !== e.value || (v === 'progress' && !g)) &&
        Sn(e, 'value', g, f.value, !1),
      'checked' in d &&
        (g = d.checked) !== void 0 &&
        g !== e.checked &&
        Sn(e, 'checked', g, f.checked, !1))
  }
  return e
}
function Vs(e, t, n) {
...
function Us(e, t, n) {
  ...
  if (
    ...
    (r = e.ref) && ((r.current && r.current !== e.__e) || Vs(r, null, t)),
  ...
  if ((r = e.__k)) for (i = 0; i < r.length; i++) r[i] && Us(r[i], t, n)
  o != null && Ms(o)
}
function th(e, t, n) {
...
function nh(e, t, n) {
  ...
  if (arguments.length > 3)
    for (n = [n], i = 3; i < arguments.length; i++) n.push(a[i])
  return (
    n != null && (s.children = n), nn(e.type, s, r || e.key, o || e.ref, null)
  )
}
;(N = {
  __e: function (e, t) {
  ...
  (Ve.prototype.setState = function (e, t) {
    ...
    ;(n =
      ...
      typeof e == 'function' && (e = e(We({}, n), this.props)),
      e && We(n, e),
      e != null && this.__v && (t && this.__h.push(t), Zr(this))
  }),
  (Ve.prototype.forceUpdate = function (e) {
    this.__v && ((this.__e = !0), e && this.__h.push(e), Zr(this))
  }),
  (Ve.prototype.render = ct),
  (tn = []),
  (Ns =
...
;(N.__b = function (e) {
  ...
  (N.diffed = function (e) {
    ...
    t &&
      t.__H &&
      t.__H.__h.length &&
      ((Xr.push(t) !== 1 && Oi === N.requestAnimationFrame) ||
        (
          (Oi = N.requestAnimationFrame) ||
          function (n) {
            var r,
              o = function () {
...
;((no.prototype = new Ve()).isPureReactComponent = !0),
  (no.prototype.shouldComponentUpdate = function (e, t) {
            ...
            r.__v.__k[0] = (function p(f, d, v) {
              return (
                f &&
                  ...
                  (f.__k =
                    f.__k &&
                    f.__k.map(function (g) {
                      return p(g, d, v)
                    })),
                  f.__c &&
                    f.__c.__P === d &&
                    (f.__e && v.insertBefore(f.__e, f.__d),
                    (f.__c.__e = !0),
                    (f.__c.__P = v))),
                f
              )
        ...
        this.__v.__k[0] = (function i(a, s, l) {
          return (
            a &&
              (a.__c &&
                a.__c.__H &&
                (a.__c.__H.__.forEach(function (u) {
                  typeof u.__c == 'function' && u.__c()
                }),
                (a.__c.__H = null)),
              (a = Qs({}, a)).__c != null &&
                (a.__c.__P === l && (a.__c.__P = s), (a.__c = null)),
              (a.__k =
                a.__k &&
                a.__k.map(function (u) {
                  return i(u, s, l)
                }))),
            a
          )
  ...
  ;(t.componentWillUnmount = function () {
    ...
    e.__v
      ? (t.l ||
        ...
        un(ze(sh, { context: t.context }, e.__v), t.l))
...
var Xs =
  ...
  uh = function (e) {
    return (
      typeof Symbol < 'u' && ln(Symbol()) == 'symbol'
        ? /fil|che|rad/i
        : /fil|che|ra/i
    ).test(e)
  }
...
N.event = function (e) {
  return (
    Di && (e = Di(e)),
    (e.persist = dh),
    (e.isPropagationStopped = fh),
    (e.isDefaultPrevented = ph),
    (e.nativeEvent = e)
  )
}
var tl,
...
N.vnode = function (e) {
  ...
  if (typeof t == 'string') {
    for (var o in ((r = {}), n)) {
      ...
      ;(o === 'value' && 'defaultValue' in n && i == null) ||
        (o === 'defaultValue' && 'value' in n && n.value == null
          ...
          ? (o = 'ondblclick')
          : /^onchange(textarea|input)/i.test(o + t) && !uh(n.type)
          ? (o = 'oninput')
    ...
    t == 'select' &&
      ...
      (r.value = Je(n.children).forEach(function (a) {
...
;(typeof performance > 'u' ? 'undefined' : ln(performance)) == 'object' &&
  ...
  memo: function (e, t) {
    function n(o) {
      ...
      return (
        ...
        t ? !t(this.props, o) || !a : to(this.props, o)
      )
    }
    function r(o) {
  ...
  forwardRef: function (e) {
    function t(n, r) {
      ...
      return (
        ...
        e(
          o,
          (r = n.ref || r) && (ln(r) != 'object' || 'current' in r) ? r : null
        )
      )
    }
    return (
...
function gh(e, t) {
  return (
    ...
    (function (n, r) {
      if (!!n) {
        if (typeof n == 'string') return Bi(n, r)
        ...
        c !== null &&
          m.createElement(
            ...
            m.createElement(
              ...
              c === 'Ctrl' ? m.createElement(mh, null) : c
            ),
            m.createElement('kbd', { className: 'DocSearch-Button-Key' }, 'K')
          )
      )
    )
  )
...
function bh(e, t) {
  return (
    ...
    (function (n, r) {
      if (!!n) {
        if (typeof n == 'string') return Hi(n, r)
        var o = Object.prototype.toString.call(n).slice(8, -1)
        if (
          (o === 'Object' && n.constructor && (o = n.constructor.name),
          o === 'Map' || o === 'Set')
...
var rl = function () {},
  xh = [{ segment: 'autocomplete-core', version: '1.7.1' }],
  Fi = { current: {} }
function Oh(e) {
  process.env.NODE_ENV !== 'production' &&
    (function (t, n) {
      if (process.env.NODE_ENV !== 'production' && !t) {
        var r = n.trim()
        Fi.current[r] ||
          ((Fi.current[r] = !0), console.warn('[Autocomplete] '.concat(r)))
      }
    })(
      !e.debug,
...
function kh(e, t) {
  ...
  return Promise.resolve(e(t)).then(function (r) {
    return (
      fn(Array.isArray(r), function () {
        return 'The `getSources` function must return an array of sources but returned type '
          .concat(
            JSON.stringify(ao(r)),
            `:
          ...
          .map(function (o) {
            ...
            var i = (function (a) {
              for (var s = 1; s < arguments.length; s++) {
                ...
                s % 2
                  ? Ui(Object(l), !0).forEach(function (u) {
                      Sh(a, u, l[u])
                    })
                  : Object.getOwnPropertyDescriptors
                  ...
                  : Ui(Object(l)).forEach(function (u) {
...
function Tt(e) {
  ...
  var n =
      t.items[
        (function (o) {
          for (
            var i = o.state, a = o.collection, s = !1, l = 0, u = 0;
            s === !1;
    ...
    dispatch: function (i, a) {
      var s = (function (l) {
        for (var u = 1; u < arguments.length; u++) {
          ...
          u % 2
            ? Wi(Object(c), !0).forEach(function (p) {
                Eh(l, p, c[p])
              })
            : Object.getOwnPropertyDescriptors
            ? Object.defineProperties(l, Object.getOwnPropertyDescriptors(c))
            : Wi(Object(c)).forEach(function (p) {
                Object.defineProperty(
                  l,
                  p,
      ...
      ;(o = e(o, { type: i, props: t, payload: a })),
        n({ state: o, prevState: s })
    },
    pendingRequests:
      ((r = []),
      {
...
function Pn(e) {
  for (var t = 1; t < arguments.length; t++) {
    var n = arguments[t] != null ? arguments[t] : {}
    t % 2
      ? Ki(Object(n), !0).forEach(function (r) {
          jh(e, r, n[r])
        })
      : Object.getOwnPropertyDescriptors
      ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(n))
      : Ki(Object(n)).forEach(function (r) {
          Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(n, r))
        })
  }
  return e
...
function Th(e) {
  return (
    ...
    (function (t, n) {
      if (!!t) {
        if (typeof t == 'string') return Pr(t, n)
...
function Pt(e) {
  for (var t = 1; t < arguments.length; t++) {
    ...
    t % 2
      ...
      : Object.getOwnPropertyDescriptors
      ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(n))
      : Ji(Object(n)).forEach(function (r) {
          Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(n, r))
        })
  }
  return e
...
function En(e) {
  for (var t = 1; t < arguments.length; t++) {
    var n = arguments[t] != null ? arguments[t] : {}
    t % 2
      ? Gi(Object(n), !0).forEach(function (r) {
          ol(e, r, n[r])
        })
      : Object.getOwnPropertyDescriptors
      ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(n))
      : Gi(Object(n)).forEach(function (r) {
          Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(n, r))
        })
  }
  return e
...
function Lh(e) {
  var t = e
    ...
    .map(function (n) {
      if (!Cn(n)) return Promise.resolve(n)
      var r = n,
        o = r.execute,
        i = r.items
  ...
  return t.map(function (n) {
    var r = e.filter(function (s) {
      ...
      a = i
            ...
            (function (s) {
                      ...
                      (c = u.hits) === null || c === void 0
                        ...
                        : c.map(function (p) {
                            return $n(
                              ...
                              {},
                              {
                                __autocomplete_indexName: u.index,
                                __autocomplete_queryID: u.queryID,
                              }
                            )
                          }),
                  }
              ...
              return {
                ...
                facetHits: l
                  .map(function (u) {
                    var c
                    return (c = u.facetHits) === null || c === void 0
                      ? void 0
                      : c.map(function (p) {
                          return {
                            label: p.value,
        ...
        : o
    return (
      fn(Array.isArray(a), function () {
        return 'The `getItems` function from source "'
          .concat(
            n.sourceId,
...
function qt(e) {
  for (var t = 1; t < arguments.length; t++) {
    var n = arguments[t] != null ? arguments[t] : {}
    t % 2
      ? Zi(Object(n), !0).forEach(function (r) {
          Bh(e, r, n[r])
        })
      : Object.getOwnPropertyDescriptors
      ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(n))
      : Zi(Object(n)).forEach(function (r) {
          Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(n, r))
        })
  }
  return e
...
function jt(e) {
  ...
  if ((p(i), f(o.defaultActiveItemId), !i && o.openOnFocus === !1)) {
    var v,
      g = s.getState().collections.map(function (k) {
        return qt(qt({}, k), {}, { items: [] })
      })
    d('idle'),
      u(g),
      c(
        (v = r.isOpen) !== null && v !== void 0
          ? v
          : o.shouldPanelOpen({ state: s.getState() })
      )
    var y = zi(
      ea(g).then(function () {
  ...
  d('loading'),
    (Wt = o.environment.setTimeout(function () {
      d('stalled')
    }, o.stallThreshold))
  var b = zi(
    ea(
      o
        .getSources(qt({ query: i, refresh: a, state: s.getState() }, l))
        .then(function (k) {
          return Promise.all(
            k.map(function (S) {
              return Promise.resolve(
                S.getItems(qt({ query: i, refresh: a, state: s.getState() }, l))
              ).then(function (x) {
...
var Uh = ['props', 'refresh', 'store'],
  qh = ['inputElement', 'formElement', 'panelElement'],
  Wh = ['inputElement'],
  Kh = ['inputElement', 'maxLength'],
  Jh = ['item', 'source']
function na(e, t) {
  var n = Object.keys(e)
  if (Object.getOwnPropertySymbols) {
      ...
      return ye(
        {
          ...
          onTouchMove: function (c) {
            r.getState().isOpen !== !1 &&
              a === t.environment.document.activeElement &&
              c.target !== a &&
              a.blur()
          },
        },
        ...
        ye(
          {
            ...
            onSubmit: function (a) {
              ...
              a.preventDefault(),
                t.onSubmit(
                  ye({ event: a, refresh: n, state: r.getState() }, o)
                ),
                r.dispatch('submit', null),
                (s = i.inputElement) === null || s === void 0 || s.blur()
            },
            onReset: function (a) {
              var s
              a.preventDefault(),
                t.onReset(ye({ event: a, refresh: n, state: r.getState() }, o)),
                r.dispatch('reset', null),
                (s = i.inputElement) === null || s === void 0 || s.focus()
            },
          },
          Kt(i, Wh)
        )
    ...
    getInputProps: function (i) {
      ...
      var l = i || {},
        ...
        d = (function (g) {
          ...
          ((a = t.environment.navigator) === null || a === void 0
            ? void 0
            : a.userAgent) || ''
        ),
        v = f != null && f.itemUrl && !d ? 'go' : 'search'
      return ye(
        {
              ...
              ye(
                {
                  event: g,
                  props: t,
                  query: g.currentTarget.value.slice(0, c),
                  refresh: n,
                  store: r,
                },
                o
          ...
          onKeyDown: function (g) {
            ;(function (y) {
              ...
              if (b.key === 'ArrowUp' || b.key === 'ArrowDown') {
                var M = function () {
                    var W = k.environment.document.getElementById(
                      ''
                        .concat(k.id, '-item-')
                        .concat(x.getState().activeItemId)
                    )
                    W &&
                      (W.scrollIntoViewIfNeeded
                        ? W.scrollIntoViewIfNeeded(!1)
                        : W.scrollIntoView(!1))
                  },
                  E = function () {
                    var W = Tt(x.getState())
                ...
                b.preventDefault(),
                  x.getState().isOpen === !1 &&
                  (k.openOnFocus || Boolean(x.getState().query))
                    ? jt(
                        _t(
                          {
                            event: b,
                            props: k,
                            query: x.getState().query,
                            refresh: S,
                            store: x,
                          },
                          P
                        ...
                        x.dispatch(b.key, {
                          nextActiveItemId: k.defaultActiveItemId,
                        }),
                          E(),
                          setTimeout(M, 0)
                      })
                ...
                b.preventDefault(),
                  x.dispatch(b.key, null),
                  x.pendingRequests.cancelAll()
              else if (b.key === 'Tab')
                x.dispatch('blur', null), x.pendingRequests.cancelAll()
              else if (b.key === 'Enter') {
                if (
                  x.getState().activeItemId === null ||
                  x.getState().collections.every(function (W) {
          ...
          onBlur: rl,
          onClick: function (g) {
            i.inputElement !== t.environment.document.activeElement ||
              r.getState().isOpen ||
              s(g)
          },
        },
      ...
      return ye(
        {
          ...
          onClick: function (u) {
            var c = s.getItemInputValue({ item: a, state: r.getState() }),
              p = s.getItemUrl({ item: a, state: r.getState() })
            ;(p
              ? Promise.resolve()
              : jt(
                  ye(
...
function Zh(e) {
  var t,
    ...
    a = e.options,
    s =
      (t = (((n = a.__autocomplete_metadata) === null || n === void 0
        ? void 0
    ...
    l = s
      ...
      : {}
  return {
    plugins: i.map(function (u) {
      return {
        name: u.name,
        options: Object.keys(u.__autocomplete_pluginOptions || []),
      }
    }),
    options: Yh({ 'autocomplete-core': Object.keys(a) }, l),
    ua: xh.concat(
...
function oa(e) {
  ...
  return n.isOpen === !1 || n.activeItemId === null
    ? null
    : ((t = Tt(n)) === null || t === void 0 ? void 0 : t.itemInputValue) || null
}
function ia(e, t) {
  var n = Object.keys(e)
  if (Object.getOwnPropertySymbols) {
...
function q(e) {
  for (var t = 1; t < arguments.length; t++) {
    var n = arguments[t] != null ? arguments[t] : {}
    t % 2
      ? ia(Object(n), !0).forEach(function (r) {
          Xh(e, r, n[r])
        })
      : Object.getOwnPropertyDescriptors
      ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(n))
      : ia(Object(n)).forEach(function (r) {
          Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(n, r))
        })
  }
  return e
...
var e0 = function (e, t) {
  switch (t.type) {
      ...
      var n = q(
        ...
        {},
        {
          activeItemId: t.payload.hasOwnProperty('nextActiveItemId')
            ...
            : Vi(1, e.activeItemId, io(e), t.props.defaultActiveItemId),
        }
      )
    ...
    case 'Escape':
      return e.isOpen
        ? q(q({}, e), {}, { activeItemId: null, isOpen: !1, completion: null })
        : q(
            q({}, e),
            {},
    ...
    case 'blur':
      return t.props.debug
        ? e
        : q(q({}, e), {}, { isOpen: !1, activeItemId: null })
    case 'mouseleave':
...
function n0(e) {
  ...
  var t = [],
    n = (function (s, l) {
      ...
      return Pt(
        ...
        {
          id:
            (u = s.id) !== null && u !== void 0
              ? u
              : 'autocomplete-'.concat(wh++),
          plugins: p,
          initialState: Pt(
            {
              activeItemId: null,
          ...
          onStateChange: function (f) {
            var d
            ;(d = s.onStateChange) === null || d === void 0 || d.call(s, f),
              p.forEach(function (v) {
                var g
                return (g = v.onStateChange) === null || g === void 0
                  ? void 0
                  : g.call(v, f)
              })
          },
          onSubmit: function (f) {
            var d
            ;(d = s.onSubmit) === null || d === void 0 || d.call(s, f),
              p.forEach(function (v) {
                var g
                return (g = v.onSubmit) === null || g === void 0
                  ? void 0
                  : g.call(v, f)
              })
          },
          onReset: function (f) {
            var d
            ;(d = s.onReset) === null || d === void 0 || d.call(s, f),
              p.forEach(function (v) {
                var g
                return (g = v.onReset) === null || g === void 0
                  ? void 0
                  : g.call(v, f)
              })
          },
                    ...
                    {},
                    {
                      onSelect: function (g) {
                        v.onSelect(g),
                          l.forEach(function (y) {
                            var b
                            return (b = y.onSelect) === null || b === void 0
                              ? void 0
                              : b.call(y, g)
                          })
                      },
                      onActive: function (g) {
                        v.onActive(g),
                          l.forEach(function (y) {
                            var b
                            return (b = y.onActive) === null || b === void 0
                              ? void 0
                              : b.call(y, g)
                          })
                      },
          ...
          var c = 0,
            p = u.map(function (f) {
              return Pn(
                ...
                {},
                {
                  items: dn(f.items).map(function (d) {
    ...
    i = Qh(yt({ props: n, refresh: a, store: r }, o))
  function a() {
    return jt(
      yt(
        {
  ...
  return (
    n.plugins.forEach(function (s) {
      var l
      return (l = s.subscribe) === null || l === void 0
        ? void 0
        : l.call(
            s,
            yt(
    ...
    (function (s) {
      ...
      if (
        ...
        u.includes('Algolia Crawler')
      ) {
        var f = p.document.createElement('meta'),
          d = p.document.querySelector('head')
        ;(f.name = 'algolia:metadata'),
          setTimeout(function () {
            ;(f.content = JSON.stringify(c)), d.appendChild(f)
          }, 0)
      }
    })({
      metadata: Zh({ plugins: n.plugins, options: e }),
...
function r0(e) {
  ...
  return m.createElement(
    ...
    m.createElement('span', { className: 'DocSearch-Label' }, r),
    m.createElement(
      'svg',
      {
        width: '77',
...
function o0(e) {
  var t = e.translations,
    ...
    u = n.navigateUpKeyAriaLabel,
    c = u === void 0 ? 'Arrow up' : u,
    p = n.navigateDownKeyAriaLabel,
    f = p === void 0 ? 'Arrow down' : p,
    d = n.closeText,
    v = d === void 0 ? 'to close' : d,
  ...
  return m.createElement(
    ...
    m.createElement(
      ...
      m.createElement(r0, { translations: { searchByText: k } })
    ),
    m.createElement(
      'ul',
      ...
      m.createElement(
        ...
        m.createElement('span', { className: 'DocSearch-Label' }, o)
      ),
      m.createElement(
        'li',
        null,
        m.createElement(
          ...
          m.createElement(
            Tn,
            { ariaLabel: f },
            m.createElement('path', { d: 'M7.5 3.5v8M10.5 8.5l-3 3-3-3' })
          )
        ),
        m.createElement(
          'kbd',
          ...
          m.createElement(
            Tn,
            { ariaLabel: c },
            m.createElement('path', { d: 'M7.5 11.5v-8M10.5 6.5l-3-3-3 3' })
          )
        ),
        m.createElement('span', { className: 'DocSearch-Label' }, l)
      ),
      m.createElement(
        'li',
        null,
        ...
        m.createElement('span', { className: 'DocSearch-Label' }, v)
      )
    )
  )
}
...
function l0() {
  return m.createElement(
    ...
    m.createElement(
      ...
      m.createElement('path', { d: 'M18 3v4c0 2-2 4-4 4H2' }),
      m.createElement('path', { d: 'M8 17l-6-6 6-6' })
    )
  )
}
var c0 = function () {
...
function m0(e) {
  ...
  return m.createElement(
    ...
    m.createElement(
      ...
      m.createElement(p0, null)
    ),
    m.createElement('p', { className: 'DocSearch-Title' }, o),
    m.createElement('p', { className: 'DocSearch-Help' }, a)
  )
}
var v0 = ['translations']
function g0(e) {
  return (
    ...
    (function (t, n) {
      if (!!t) {
        if (typeof t == 'string') return jr(t, n)
        var r = Object.prototype.toString.call(t).slice(8, -1)
        if (
          (r === 'Object' && t.constructor && (r = t.constructor.name),
          r === 'Map' || r === 'Set')
...
function y0(e) {
  var t = e.translations,
    ...
    s = a === void 0 ? 'Try searching for' : a,
    l = n.reportMissingResultsText,
    u = l === void 0 ? 'Believe this query should return results?' : l,
    c = n.reportMissingResultsLinkText,
    p = c === void 0 ? 'Let us know.' : c,
    f = r.state.context.searchSuggestions
  return m.createElement(
    'div',
    ...
    m.createElement(
      ...
      i,
      ' "',
      m.createElement('strong', null, r.state.query),
      '"'
    ),
    f &&
      f.length > 0 &&
      m.createElement(
        ...
        m.createElement('p', { className: 'DocSearch-Help' }, s, ':'),
        m.createElement(
          'ul',
          null,
          f.slice(0, 3).reduce(function (d, v) {
            return [].concat(g0(d), [
              m.createElement(
                'li',
                { key: v },
...
function ca(e) {
  for (var t = 1; t < arguments.length; t++) {
    var n = arguments[t] != null ? arguments[t] : {}
    t % 2
      ? la(Object(n), !0).forEach(function (r) {
          w0(e, r, n[r])
        })
      : Object.getOwnPropertyDescriptors
      ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(n))
      : la(Object(n)).forEach(function (r) {
          Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(n, r))
        })
  }
  return e
    ...
    ca(
      ...
      {},
      {
        dangerouslySetInnerHTML: {
          __html: ua(t, '_snippetResult.'.concat(n, '.value')) || ua(t, n),
        },
      }
    )
  )
...
function co(e) {
  return e.collection && e.collection.items.length !== 0
    ? m.createElement(
        ...
        m.createElement('div', { className: 'DocSearch-Hit-source' }, e.title),
        m.createElement(
          'ul',
          e.getListProps(),
          e.collection.items.map(function (t, n) {
            return m.createElement(
              O0,
              Xn({ key: [e.title, t.objectID].join(':'), item: t, index: n }, e)
            )
          })
        )
      )
  ...
  return m.createElement(
              ...
              i.__docsearch_parent &&
                m.createElement(
                  ...
                  m.createElement(
                    ...
                    i.__docsearch_parent !==
                      ((o = t.items[a + 1]) === null || o === void 0
                        ? void 0
                        : o.__docsearch_parent)
                      ? m.createElement('path', { d: 'M8 6v21M20 27H8.3' })
                      : m.createElement('path', { d: 'M8 6v42M20 27H8.3' })
                  )
                ),
              m.createElement(
                'div',
                { className: 'DocSearch-Hit-icon' },
                m.createElement(u0, { type: i.type })
              )
            )
          },
    ...
    e.resultsFooterComponent &&
      m.createElement(
        ...
        m.createElement(e.resultsFooterComponent, { state: e.state })
      )
  )
}
var P0 = ['translations']
          ...
          er({}, r, {
            ...
            renderIcon: function () {
              return m.createElement(
                'div',
                { className: 'DocSearch-Hit-icon' },
                m.createElement(s0, null)
              )
            },
            renderAction: function (y) {
              var b = y.item,
                k = y.runFavoriteTransition,
                    ...
                    'button',
                    {
                      ...
                      onClick: function (x) {
                        x.preventDefault(),
                          x.stopPropagation(),
                          k(function () {
                            r.favoriteSearches.add(b),
                              r.recentSearches.remove(b),
                              r.refresh()
                          })
                      },
                    },
...
function N0(e) {
  var t = e.translations,
    ...
    s = a === void 0 ? 'Clear the query' : a,
    l = n.cancelButtonText,
    u = l === void 0 ? 'Cancel' : l,
    c = n.cancelButtonAriaLabel,
    p = c === void 0 ? 'Cancel' : c,
    f = r.getFormProps({ inputElement: r.inputRef.current }).onReset
  return (
    m.useEffect(
      function () {
    ...
    m.createElement(
      ...
      m.createElement(
        ...
        m.createElement(
          'label',
          nr({ className: 'DocSearch-MagnifierLabel' }, r.getLabelProps()),
          m.createElement(nl, null)
        ),
        m.createElement(
          'div',
          { className: 'DocSearch-LoadingIndicator' },
          m.createElement(a0, null)
        ),
        m.createElement(
          'input',
          nr(
...
function ma(e) {
  ...
  return {
    add: function (a) {
      var s = a,
        l = (s._highlightResult, s._snippetResult, M0(s, L0)),
        u = i.findIndex(function (c) {
...
function fl(e) {
  return typeof e == 'string'
    ? { protocol: 'https', url: e, accept: At.Any }
    : {
        protocol: e.protocol || 'https',
        url: e.url,
        accept: e.accept || At.Any,
      }
}
var ga = 'GET',
  mr = 'POST'
...
function _a(e, t, n, r) {
  var o = [],
    ...
    s = n.method,
    l = n.method !== ga ? {} : Q(Q({}, n.data), r.data),
    u = Q(
      Q(Q({ 'x-algolia-agent': e.userAgent.value }, e.queryParameters), l),
      r.queryParameters
    ),
    c = 0,
    p = function f(d, v) {
      ...
      var y = {
          ...
          method: s,
          url: q0(g, n.path, u),
          connectTimeout: v(c, e.timeouts.connect),
          responseTimeout: v(c, r.timeout),
        },
        b = function (S) {
        ...
        k = {
          ...
          onRetry: function (S) {
            ...
            return (
              S.isTimedOut && c++,
              Promise.all([
                e.logger.info('Retryable failure', hl(x)),
                e.hostsCache.set(g, dl(g, S.isTimedOut ? ul : z0)),
              ]).then(function () {
                return f(d, v)
              })
            )
  ...
  return Q(
    ...
    {},
    {
      request: Q(
        Q({}, e.request),
        {},
        { headers: Q(Q({}, e.request.headers), t) }
      ),
    }
  )
}
var W0 = function (e) {
    var t = e.appId,
      ...
      })(e.authMode !== void 0 ? e.authMode : Mn.WithinHeaders, t, e.apiKey),
      r = (function (i) {
        var a = i.hostsCache,
          s = i.logger,
          l = i.requester,
          ...
          g = {
            ...
            headers: i.headers,
            queryParameters: v,
            hosts: d.map(function (y) {
              return fl(y)
            }),
            read: function (y, b) {
              var k = va(b, g.timeouts.read),
                S = function () {
                  return _a(
                    g,
                    g.hosts.filter(function (P) {
                      return (P.accept & At.Read) != 0
                    }),
                    y,
                    k
                  )
              ...
              var x = {
                request: y,
                mappedRequestOptions: k,
                transporter: {
                  queryParameters: g.queryParameters,
                  headers: g.headers,
                },
              }
              return g.responsesCache.get(
                x,
                function () {
                  return g.requestsCache.get(x, function () {
                    return g.requestsCache
                      .set(x, S())
                      .then(
                        function (P) {
            ...
            write: function (y, b) {
              return _a(
                g,
                g.hosts.filter(function (k) {
                  return (k.accept & At.Write) != 0
                }),
                y,
                va(b, g.timeouts.write)
              )
            },
          }
        return g
        ...
        Q(
          Q(
            {
              hosts: [
                { url: ''.concat(t, '-dsn.algolia.net'), accept: At.Read },
                { url: ''.concat(t, '.algolia.net'), accept: At.Write },
              ].concat(
                F0([
          ...
          {},
          {
            ...
            queryParameters: Q(Q({}, n.queryParameters()), e.queryParameters),
          }
        )
      ),
      o = {
      ...
      return Promise.all(
        t.map(function (r) {
          var o = r.params,
            ...
            a = o.facetQuery,
            s = Zp(o, B0)
          return ml(e)(r.indexName, {
            methods: { searchForFacetValues: vl },
          }).searchForFacetValues(i, a, Q(Q({}, n), s))
        })
      )
    }
  },
  K0 = function (e) {
    return function (t, n, r) {
      return e.transporter.read(
        {
          method: mr,
          path: hr('1/answers/%s/prediction', e.indexName),
  ...
  J0 = function (e) {
    return function (t, n) {
      return e.transporter.read(
        {
          method: mr,
          path: hr('1/indexes/%s/query', e.indexName),
          data: { query: t },
          cacheable: !0,
        },
        n
  ...
  vl = function (e) {
    return function (t, n, r) {
      return e.transporter.read(
        {
          method: mr,
          path: hr('1/indexes/%s/facets/%s/query', e.indexName, t),
          data: { facetQuery: n },
          cacheable: !0,
        },
        r
...
function gl(e, t, n) {
  var r,
    o = {
        ...
        send: function (i) {
          return new Promise(function (a) {
            ...
            s.open(i.method, i.url, !0),
              Object.keys(i.headers).forEach(function (p) {
            ...
            ;(s.onreadystatechange = function () {
              s.readyState > s.OPENED &&
                l === void 0 &&
                (clearTimeout(c), (l = u(i.responseTimeout, 'Socket timeout')))
            }),
              (s.onerror = function () {
                s.status === 0 &&
                  (clearTimeout(c),
      ...
      responsesCache: Tr(),
      requestsCache: Tr({ serializable: !1 }),
      hostsCache: Gt({
        caches: [H0({ key: ''.concat('4.8.5', '-').concat(e) }), Tr()],
      }),
      userAgent: U0('4.8.5').add({ segment: 'Browser', version: 'lite' }),
      authMode: Mn.WithinQueryParameters,
    }
  return W0(
    Q(
      Q(Q({}, o), n),
      {},
      {
        methods: {
          search: ba,
          searchForFacetValues: wa,
          multipleQueries: ba,
          multipleSearchForFacetValues: wa,
          initIndex: function (i) {
            return function (a) {
              return ml(i)(a, {
                methods: {
                  search: J0,
                  searchForFacetValues: vl,
                  findAnswers: K0,
                },
              })
            }
...
function Ar(e) {
  for (var t = 1; t < arguments.length; t++) {
    ...
    t % 2
      ...
      : Object.getOwnPropertyDescriptors
      ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(n))
      : xa(Object(n)).forEach(function (r) {
          Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(n, r))
        })
  }
  return e
...
function e1(e, t) {
  return (
    ...
    (function (n, r) {
      if (!!n) {
        if (typeof n == 'string') return Oa(n, r)
        var o = Object.prototype.toString.call(n).slice(8, -1)
        if (
          (o === 'Object' && n.constructor && (o = n.constructor.name),
          o === 'Map' || o === 'Set')
...
function n1(e) {
  var t = e.appId,
    ...
    S = k === void 0 ? ha : k,
    x = e.disableUserPersonalization,
    P = x !== void 0 && x,
    M = e.initialQuery,
    E = M === void 0 ? '' : M,
    j = e.translations,
    ...
    V = m.useRef(E || I).current,
    ie = (function (z, G, ae) {
      return m.useMemo(
        function () {
          var ue = gl(z, G)
          return (
            ue.addAlgoliaAgent('docsearch', '3.2.2'),
            /docsearch.js \(.*\)/.test(ue.transporter.userAgent.value) === !1 &&
              ue.addAlgoliaAgent('docsearch-react', '3.2.2'),
            ae(ue)
          )
        },
        [z, G, ae]
    ...
    te = m.useRef(
      ma({ key: '__DOCSEARCH_FAVORITE_SEARCHES__'.concat(r), limit: 10 })
    ).current,
    ne = m.useRef(
      ma({
    ...
    je = m.useCallback(
      function (z) {
        if (!P) {
          ...
          G &&
            te.getAll().findIndex(function (ae) {
    ...
    Se = m.useMemo(
              ...
              ? ie
                      ...
                      params: Ar(
                        {
                          ...
                          attributesToSnippet: [
                            'hierarchy.lvl1:'.concat(O.current),
                            'hierarchy.lvl2:'.concat(O.current),
                            'hierarchy.lvl3:'.concat(O.current),
                            'hierarchy.lvl4:'.concat(O.current),
                            'hierarchy.lvl5:'.concat(O.current),
                            'hierarchy.lvl6:'.concat(O.current),
                            'content:'.concat(O.current),
                          ],
                          snippetEllipsisText: '\u2026',
                  ...
                  .then(function (re) {
                    var de = re.results[0],
                      ge = de.hits,
                      Ue = de.nbHits,
                      ht = pa(ge, function (mt) {
                        return sl(mt)
                      })
                    return (
                      ae.context.searchSuggestions.length <
                        Object.keys(ht).length &&
                        ue({ searchSuggestions: Object.keys(ht) }),
                      ue({ nbHits: Ue }),
                      Object.values(ht).map(function (mt, Ft) {
                        return {
                          sourceId: 'hits'.concat(Ft),
                          onSelect: function (Te) {
                            var rt = Te.item,
                              Ne = Te.event
                            je(rt),
      ...
      [r, a, ie, l, ne, te, je, V, i, g, c, P]
    ),
    ke = Se.getEnvironmentProps,
    me = Se.getRootProps,
    nt = Se.refresh
  return (
    (function (z) {
      var G = z.getEnvironmentProps,
        ae = z.panelElement,
        ue = z.formElement,
        Pe = z.inputElement
      m.useEffect(
        function () {
          if (ae && ue && Pe) {
            var re = G({ panelElement: ae, formElement: ue, inputElement: Pe }),
              de = re.onTouchStart,
              ge = re.onTouchMove
            return (
              ...
              function () {
                window.removeEventListener('touchstart', de),
                  window.removeEventListener('touchmove', ge)
              }
            )
          }
        },
      ...
      getEnvironmentProps: ke,
      panelElement: pt.current,
      formElement: tt.current,
    ...
    (function (z) {
      ...
      m.useEffect(
        function () {
          if (G) {
            var ae = G.querySelectorAll(
                'a[href]:not([disabled]), button:not([disabled]), input:not([disabled])'
              ),
              ue = ae[0],
              Pe = ae[ae.length - 1]
            return (
              G.addEventListener('keydown', re),
              function () {
            ...
            de.key === 'Tab' &&
              (de.shiftKey
                ? document.activeElement === ue &&
                  (de.preventDefault(), Pe.focus())
                : document.activeElement === Pe &&
                  (de.preventDefault(), ue.focus()))
          }
        },
        [G]
      )
    ...
    m.createElement(
      'div',
      rn({ ref: Ce }, me({ 'aria-expanded': !0 }), {
        className: [
          'DocSearch',
          'DocSearch-Container',
          le.status === 'stalled' && 'DocSearch-Container--Stalled',
          le.status === 'error' && 'DocSearch-Container--Errored',
        ]
          .filter(Boolean)
          .join(' '),
        role: 'button',
      ...
      m.createElement(
        'div',
        { className: 'DocSearch-Modal', ref: Fe },
        m.createElement(
          'header',
          { className: 'DocSearch-SearchBar', ref: tt },
          m.createElement(
            N0,
            rn({}, Se, {
              state: le,
              autoFocus: V.length === 0,
              inputRef: L,
              isFromSelection: Boolean(V) && V === I,
              translations: Y,
              onClose: l,
            })
          )
        ...
        m.createElement(
          'div',
          { className: 'DocSearch-Dropdown', ref: pt },
          m.createElement(
            A0,
            rn({}, Se, {
              indexName: r,
        ...
        m.createElement(
          ...
          m.createElement(o0, { translations: H })
        )
      )
    )
  )
...
function Sa(e, t) {
  return (
    ...
    (function (n, r) {
      if (!!n) {
        if (typeof n == 'string') return ka(n, r)
        var o = Object.prototype.toString.call(n).slice(8, -1)
        if (
          (o === 'Object' && n.constructor && (o = n.constructor.name),
          o === 'Map' || o === 'Set')
...
function r1(e) {
  var t,
    ...
    i = o[0],
    a = o[1],
    s = Sa(m.useState((e == null ? void 0 : e.initialQuery) || void 0), 2),
    l = s[0],
    u = s[1],
    c = m.useCallback(
      function () {
    ...
    m.createElement(
      ...
      Qr({}, e, {
        transformSearchClient: function (t) {
          return (
            t.addAlgoliaAgent('docsearch.js', '3.2.2'),
  ...
  a1 = /* @__PURE__ */ D({
    ...
    setup(e) {
      ...
      function l(f) {
        o &&
          o.vnode.el &&
          ((o.vnode.el.innerHTML =
            '<div class="algolia-search-box" id="docsearch"></div>'),
          p(f))
      }
      function u(f) {
        if (f.startsWith('http')) return window.location.assign(f)
        window.location.assign(window.location.origin + f)
      }
      function c(f) {
        const d = (() =>
          f.includes('api-reference') ||
          (f.includes('docs.') && !f.startsWith(window.location.origin))
            ? f
            : f.startsWith('http')
            ? s(f)
            : f)()
          ...
          Object.assign({}, f, {
            ...
            navigator: {
              navigate: ({ suggestionUrl: d }) => {
                const v = c(d)
                if (v.startsWith('http') || a.path === v) return u(v)
                i.go(v)
              },
            },
            transformItems: (d) =>
...
const s1 = /* @__PURE__ */ h(
  ...
  l1 = { class: 'hidden lg:block' },
  c1 = /* @__PURE__ */ h('span', { class: 'ml-2' }, 'Search', -1),
  u1 = { class: 'sr-only' },
  d1 = {
  ...
  $a = /* @__PURE__ */ D({
    __name: 'SearchButton',
    setup(e) {
      const t = typeof navigator < 'u' ? navigator.platform : '',
        n = /(Mac|iPhone|iPod|iPad)/i.test(t) ? '\u2318' : 'Ctrl ',
        r = /(Mac|iPhone|iPod|iPad)/i.test(t) ? 'Command' : 'Control',
        o = () => {
          ...
          w(
            ...
            [
              ...
              h(
                ...
                {
                  class:
                    'relative flex cursor-pointer items-center rounded-md p-2 text-white transition-shadow dark:ring-slate-300/10 lg:bg-white/20 lg:px-3 lg:py-1.5 lg:pr-20 lg:hover:shadow-md lg:dark:bg-white/10 lg:dark:ring-1 lg:dark:hover:ring-cyan-400/50',
                  onClick: o,
                },
                [
                  s1,
                    ...
                    B(l, null, {
                      default: pe(() => [
                        h(
                          'span',
                          u1,
                          'Press ' + U($(r)) + '+K to open quick search',
                          1
                        ),
                        h('span', d1, U($(n)) + 'K', 1),
                      ]),
  ...
  f1 = /* @__PURE__ */ h(
    'a',
    {
      ...
      class:
        'flex flex-col content-center items-center justify-center bg-white px-4 py-2 text-white dark:border-b dark:border-white/10 dark:bg-transparent md:flex-row',
    },
    [
      /* @__PURE__ */ h(
        'span',
      ...
      /* @__PURE__ */ h(
        ...
        {
          class:
            'ml-2 text-sm font-bold text-gray-900 underline dark:text-white',
        },
        [
  ...
  p1 = { class: 'nav-bar top-0 z-10 lg:sticky' },
  h1 = {
    class:
      'bg-ns-blue py-4 backdrop-blur dark:bg-slate-900 dark:[@supports(backdrop-filter:blur(0))]:bg-slate-900/80',
  },
  m1 = {
    class:
  ...
  v1 = { class: 'flex flex-1 items-center' },
  g1 = { class: 'flex w-full items-center justify-between lg:w-auto' },
  _1 = ['href'],
  y1 = /* @__PURE__ */ h('span', { class: 'sr-only' }, 'NativeScript', -1),
  b1 = { class: 'flex items-center space-x-4 lg:hidden' },
  w1 = { class: '-mr-1 flex items-center' },
  x1 = ['aria-expanded'],
  O1 = /* @__PURE__ */ h('span', { class: 'sr-only' }, 'Open main menu', -1),
  S1 = /* @__PURE__ */ h(
    'svg',
    {
      class: 'h-6 w-6',
  ...
  k1 = [O1, S1],
  $1 = { class: 'ml-10 hidden space-x-8 lg:flex' },
  P1 = { class: 'flex flex-1 justify-center px-2 lg:justify-end' },
  E1 = { class: 'w-full max-w-xl xl:max-w-xs' },
  C1 = { class: 'hidden lg:flex lg:items-center lg:space-x-6' },
  j1 = ['href', 'target'],
  T1 = { class: 'relative' },
  A1 = ['aria-expanded'],
  I1 = /* @__PURE__ */ h(
  ...
  M1 = {
    class:
      'overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 dark:shadow-none dark:ring-slate-300/10',
  },
  R1 = {
    class:
      'relative grid gap-6 bg-white px-5 py-6 dark:bg-slate-800 sm:gap-8 sm:p-8',
  },
  B1 = ['href', 'target'],
  H1 = { class: 'text-base font-medium text-gray-900 dark:text-slate-200' },
  F1 = { class: 'mt-1 text-sm text-gray-500 dark:text-slate-400' },
  z1 = /* @__PURE__ */ h(
    'a',
    {
      ...
      rel: 'noopener noreferrer',
      class:
        'inline-flex items-center justify-center rounded-md p-2 text-gray-900 transition-colors hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-transparent dark:text-white dark:hover:text-amber-200',
      'aria-expanded': 'false',
    },
    [
      /* @__PURE__ */ h(
  ...
  U1 = {
    class:
      'overflow-hidden rounded-lg bg-white shadow-md ring-1 ring-black ring-opacity-5',
  },
  q1 = { class: 'flex items-center justify-between px-5 pt-4' },
  W1 = { class: '-mr-3' },
  K1 = /* @__PURE__ */ h('span', { class: 'sr-only' }, 'Close menu', -1),
  J1 = /* @__PURE__ */ h(
    'svg',
    {
      class: 'h-6 w-6',
  ...
  G1 = [K1, J1],
  Q1 = { class: 'pt-5 pb-6' },
  Y1 = { class: 'space-y-1 px-2' },
  Z1 = ['href', 'target'],
  X1 = /* @__PURE__ */ h('hr', { class: '-mx-2' }, null, -1),
  em = ['href', 'target'],
  tm = /* @__PURE__ */ D({
    __name: 'Header',
    props: {
                        ...
                        h('div', w1, [
                          h(
                            'button',
                            {
                              ...
                              type: 'button',
                              class:
                                '-mx-2 inline-flex items-center justify-center rounded-md p-2 text-white focus:bg-white/20 dark:focus:bg-white/10',
                        ...
                        (i, a) => (
                          ...
                          w(
                            'a',
                            {
                              ...
                              target: i.target,
                              class:
                                'border-b-4 border-transparent text-base font-medium text-white hover:border-blue-100',
                            },
                            U(i.text),
                            9,
                            j1
                    ...
                    h('div', T1, [
                      h(
                        'button',
                        {
                          ...
                          class: Z([
                            'relative z-20 inline-flex items-center justify-center rounded-md p-2 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-transparent',
                            {
                              'bg-white text-gray-900': n.value,
                              'text-white hover:text-gray-900 dark:hover:text-slate-400':
                                !n.value,
                            },
                          ]),
                          role: 'button',
                              ...
                              ? (_(),
                                w('button', {
                                  ...
                                  onClick:
                                    o[2] || (o[2] = (i) => (n.value = !1)),
                                  class:
                                    'fixed inset-0 z-10 h-screen w-screen cursor-default bg-slate-300/40 transition duration-200 dark:bg-slate-900/70',
                                }))
                              : J('', !0),
                          ]),
                          _: 1,
                                          ...
                                          (i, a) => (
                                            ...
                                            w(
                                              'a',
                                              {
                                                ...
                                                target: i.target,
                                                class:
                                                  '-m-3 block rounded-md p-3 transition duration-150 ease-in-out hover:bg-gray-50 dark:hover:bg-slate-700/50',
                                              },
                                              [
                                                h('p', H1, U(i.text), 1),
                              ...
                              h('div', W1, [
                                h(
                                  'button',
                                  {
                                    ...
                                    type: 'button',
                                    class:
                                      'inline-flex items-center justify-center rounded-md bg-white p-2 text-gray-400 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-600',
                                  },
                                  G1
                                ),
                              ]),
...
const sm = /* @__PURE__ */ Bt(nm, [['render', am]]),
  lm = {
    class: 'flex',
  ...
  dm = /* @__PURE__ */ h('span', { class: 'sr-only' }, 'Home', -1),
  fm = { class: 'flex items-center' },
  pm = /* @__PURE__ */ D({
    __name: 'Breadcrumbs',
    setup(e) {
      const t = yn(),
        ...
        o = A(() => {
          ...
          for (
            ...
            let s
            a.hidden ? !a.href && a.parent : (s = a.link),
              i.unshift({
                name: a.text,
                href: s,
                current: !1,
                        ...
                        ce(
                          hn(s.href ? 'a' : 'div'),
                          {
                            ...
                            class: Z([
                              ...
                              s.href
                                ? 'hover:text-slate-700 dark:hover:text-cyan-300'
                                : '',
                            ]),
                            'aria-current': s.current ? 'page' : void 0,
                          },
                          {
                            default: pe(() => [Ae(U(s.name), 1)]),
                            _: 2,
                          },
                          1032,
  ...
  mm = { class: 'mt-2 flex -space-x-1 overflow-hidden' },
  vm = ['href'],
  gm = ['src', 'alt'],
  _m = /* @__PURE__ */ D({
                    ...
                    h(
                      ...
                      [
                        h(
                          ...
                          {
                            class:
                              'inline-block h-6 w-6 cursor-pointer rounded-full ring-2 ring-white dark:ring-slate-800',
                            src: a.avatarURL,
                            alt: a.username,
                          },
                          null,
  ...
  ym = { class: 'text-xs text-slate-500' },
  bm = ['datatime'],
  wm = /* @__PURE__ */ D({
    ...
    setup(e) {
      const { theme: t, page: n } = De(),
        r = A(() => {
          if (!!n.value.lastUpdated) return new Date(n.value.lastUpdated)
        }),
        o = A(() => {
          var a
        ...
        se(() => {
          Oe(() => {
            ...
            i.value =
              (a = r.value) == null
                ? void 0
                : a.toLocaleString(window.navigator.language)
          })
        }),
        (a, s) => {
          var l
          return Nt(
            ...
            w(
              ...
              [
                Ae(
                  U((l = $(t).lastUpdatedText) != null ? l : 'Last updated') +
                    ': ',
                  1
                ),
...
;(function (e, t) {
  ;(function (n, r) {
    ...
    var S = function (O, I, V, ie) {
        ...
        if (O === I && V === ie) return k
        for (
          var te = c ? new Float32Array(l) : new Array(l), ne = 0;
          ne < l;
          ++ne
        )
          te[ne] = v(ne * u, O, V)
    ...
    var E = {
        ...
        off: function (O, I, V) {
          I instanceof Array || (I = [I])
          for (var ie = 0; ie < I.length; ie++) O.removeEventListener(I[ie], V)
        },
    ...
    var H = function () {
        ...
        function Ol(_e) {
          var ve = _e.scrollTop
          return (
            _e.tagName.toLowerCase() === 'body' &&
              (ve = ve || document.documentElement.scrollTop),
            ve
          )
        }
        function Sl(_e) {
          ...
          return (
            _e.tagName.toLowerCase() === 'body' &&
              (ve = ve || document.documentElement.scrollLeft),
            ve
          )
        }
        function $o() {
          ;(ht = E.cumulativeOffset(I)),
            (mt = E.cumulativeOffset(O)),
            z && ((ue = mt.left - ht.left + ne), (de = ue - ae)),
            G && ((re = mt.top - ht.top + ne), (ge = re - Pe))
        }
        function Po(_e) {
          if (Ue) return Eo()
          Ne || (Ne = _e),
            ...
            (zt = Math.min(gr / V, 1)),
            (zt = rt(zt)),
            Co(I, Pe + ge * zt, ae + de * zt),
            gr < V ? window.requestAnimationFrame(Po) : Eo()
        }
        function Eo() {
          Ue || Co(I, re, ue),
            (Ne = !1),
        ...
        function Co(_e, ve, oe) {
          G && (_e.scrollTop = ve),
            z && (_e.scrollLeft = oe),
            _e.tagName.toLowerCase() === 'body' &&
              (G && (document.documentElement.scrollTop = ve),
              z && (document.documentElement.scrollLeft = oe))
        }
        function kl(_e, ve) {
          var oe =
          ...
          if (
            (n(ve) === 'object'
              ? (oe = ve)
              : typeof ve == 'number' && (oe.duration = ve),
            (O = E.$(_e)),
            !O)
          )
            return console.warn(
          ...
          if (
            ((I = E.$(oe.container || C.container)),
            (V = oe.hasOwnProperty('duration') ? oe.duration : C.duration),
            (te = oe.hasOwnProperty('lazy') ? oe.lazy : C.lazy),
            (ie = oe.easing || C.easing),
            (ne = oe.hasOwnProperty('offset') ? oe.offset : C.offset),
            (je = oe.hasOwnProperty('force') ? oe.force !== !1 : C.force),
            (Se = oe.hasOwnProperty('cancelable')
              ? oe.cancelable !== !1
              : C.cancelable),
            (ke = oe.onStart || C.onStart),
            (me = oe.onDone || C.onDone),
            (nt = oe.onCancel || C.onCancel),
            (z = oe.x === void 0 ? C.x : oe.x),
            (G = oe.y === void 0 ? C.y : oe.y),
            typeof ne == 'function' && (ne = ne(O, I)),
            (ae = Sl(I)),
            (Pe = Ol(I)),
            $o(),
            (Ue = !1),
          ...
          return (
            typeof ie == 'string' && (ie = x[ie] || x.ease),
            (rt = S.apply(S, ie)),
            E.on(I, j, Te, {
              passive: !0,
            }),
            window.requestAnimationFrame(Po),
            function () {
              ;(Ft = null), (Ue = !0)
            }
          )
    ...
    function ee(L) {
      for (var O = 0; O < W.length; ++O)
        if (W[O].el === L) return W.splice(O, 1), !0
      return !1
    }
    function le(L) {
      for (var O = 0; O < W.length; ++O) if (W[O].el === L) return W[O]
    }
    function He(L) {
      var O = le(L)
      return (
    ...
    function Ce(L) {
      ...
      if (!!O.value) {
        if ((L.preventDefault(), typeof O.value == 'string')) return Y(O.value)
    ...
    return (
      typeof window < 'u' &&
        window.Vue &&
        ((window.VueScrollTo = tt),
        (window.VueScrollTo.setDefaults = R),
        (window.VueScrollTo.scroller = H),
        window.Vue.use && window.Vue.use(pt)),
      (tt.install = pt),
      tt
    )
  })
...
const yl = _l.exports,
  ...
  Om = { class: 'mt-4 text-sm leading-6 text-slate-700 dark:text-slate-400' },
  Sm = ['onClick'],
  km = ['href'],
  $m = { key: 0 },
  Pm = { class: '' },
  ...
  Cm = /* @__PURE__ */ h(
    'svg',
    {
      ...
      fill: 'currentColor',
      class:
        'h-6 w-6 overflow-visible p-1 text-slate-400 group-hover:text-slate-600 dark:text-slate-600 dark:group-hover:text-slate-500',
    },
    [
      /* @__PURE__ */ h('path', {
        'fill-rule': 'evenodd',
  ...
  jm = /* @__PURE__ */ D({
    ...
    setup(e) {
      const { page: t } = De(),
        ...
        r = A(() =>
          n.value
            .flatMap((p) => [p.link, ...p.children.map((f) => f.link)])
            .map((p) => {
              if (p.charAt(0) === '#') return p.substring(1)
            })
            .filter(Boolean)
        )
      function o(p) {
        ...
        if (!f) return -1
        let d = window.getComputedStyle(f),
          v = parseFloat(d.scrollMarginTop),
          g = parseFloat(d.marginTop)
      ...
      Oe(() => {
        let p
        for (const f of r.value) a.value >= o(f) && (p = f)
        i.value = p != null ? p : r.value[0]
      })
      function s(p) {
        return Ir
          ? p.link.substring(1) === i.value
            ? !0
            : p.children
            ? p.children.findIndex(s) > -1
            : !1
          : !1
      }
      function l({ target: p }) {
        const f = '#' + p.href.split('#')[1],
          d = document.querySelector(decodeURIComponent(f))
        d == null || d.focus()
      }
      const u = A(() => (p) => {
          const f = s(p)
            ...
            d = p.title.includes(' ') ? 'break-words' : 'break-all'
          return f + ' ' + d
        }),
        c = () => {
          yl.scrollTo('#top', 200, {
              ...
              h('li', null, [
                h(
                  'button',
                  {
                    ...
                    class:
                      'block py-1 font-medium opacity-50 transition-opacity hover:text-slate-900 hover:opacity-100 dark:hover:text-slate-300',
                  },
                  ' \u2191 Top ',
                  8,
                  Sm
...
function Tm() {
  ...
  return A(() => {
    var s, l
    const n = yn(),
      r = xo(n.value).filter((u) => !!u.link),
      o = r.findIndex((u) => St(t.value.relativePath, u.link)),
      i = e.value.prev ? r.find((u) => u.link === e.value.prev) : r[o - 1],
      a = e.value.next ? r.find((u) => u.link === e.value.next) : r[o + 1]
    return {
      prev: e.value.prev !== !1 &&
        i && { ...i, text: (s = e.value.prevText) != null ? s : i.text },
      next: e.value.next !== !1 &&
        a && { ...a, text: (l = e.value.nextText) != null ? l : a.text },
    }
  })
}
const Am = {
  ...
  Nm = { class: 'mt-1' },
  Lm = ['href'],
  Mm = /* @__PURE__ */ h('span', { 'aria-hidden': 'true' }, '\u2190', -1),
  Rm = ['innerHTML'],
  Bm = {
    key: 1,
  ...
  zm = ['href'],
  Vm = ['innerHTML'],
  Um = /* @__PURE__ */ h('span', { 'aria-hidden': 'true' }, '\u2192', -1),
  qm = /* @__PURE__ */ D({
...
function Wm() {
  const { theme: e, page: t } = De(),
    n = pn()
  return A(() => {
    const { text: r = 'Edit this page', pattern: o } = e.value.editLink || {},
...
const Km = {
  ...
  Jm = { class: 'flex w-full' },
  Gm = { class: 'min-w-0 flex-auto' },
  Qm = /* @__PURE__ */ h(
    'div',
    {
      class:
        'mx-2 rounded-b-md bg-amber-100/70 px-4 py-2 text-amber-900 dark:mt-px dark:bg-amber-400/10 dark:text-amber-300 dark:ring-1 dark:ring-amber-300/30',
    },
    [
      /* @__PURE__ */ h('strong', null, 'Note:'),
      /* @__PURE__ */ Ae(
        ' You are on the beta version of our docs. This is a work in progress and may contain broken links and pages. '
      ),
    ],
    -1
  ),
  Ym = { class: 'mt-4 flex h-[42px] items-center' },
  Zm = { class: 'px-6 pt-10 pb-[70vh] xl:px-10' },
  Xm = {
    key: 0,
    id: 'header',
  },
  e2 = {
    key: 0,
    class:
      'mb-2 text-base font-semibold leading-6 text-blue-500 dark:text-cyan-400',
  },
  t2 = {
    class:
      'text-2xl font-bold tracking-tight text-slate-900 dark:text-slate-200 sm:text-4xl',
  },
  n2 = { class: 'mt-2 text-lg text-slate-700 dark:text-slate-400' },
  r2 = { class: 'hidden w-72 flex-none xl:block' },
  o2 = {
    class: 'h-sidebar sticky top-[72px] overflow-y-auto overflow-x-hidden',
  },
  i2 = { class: 'pt-16 pb-10 pr-3' },
  a2 = ['href'],
  s2 = /* @__PURE__ */ D({
    __name: 'default',
    setup(e) {
      const { page: t } = De(),
        ...
        r = yn(),
        o = A(() => xo(r.value)),
        i = A(() => o.value.find((l) => St(t.value.relativePath, l.link))),
        a = A(() => {
          var l, u
          return t.value.title
            ? t.value.title
            : (u = (l = i.value) == null ? void 0 : l.text) != null
            ? u
            : !1
        }),
        s = A(() => {
          var u
          if (t.value.frontmatter.category) return t.value.frontmatter.category
          let l = i.value
          for (; l != null && l.parent; ) l = l.parent
        ...
        return (
          ...
          w('div', Km, [
            h('div', Jm, [
              h('div', Gm, [
                Qm,
                h('div', Ym, [B(pm, { class: 'px-6 xl:px-10' })]),
                h('div', Zm, [
                  $(a)
                    ? (_(),
                      w('header', Xm, [
                  ...
                  B(c, {
                    class:
                      'prose-headings:font-display prose prose-slate mx-auto max-w-none prose-a:font-semibold prose-lead:text-slate-500 dark:prose-invert dark:prose-a:text-cyan-400 dark:prose-hr:border-slate-800 dark:prose-lead:text-slate-400',
                  }),
                  B(qm),
                ]),
              ]),
                          ...
                          [
                            ...
                            h(
                              'a',
                              {
                                ...
                                target: '_blank',
                                class:
                                  'mt-4 block rounded-md border border-gray-400 bg-white px-4 py-2 text-center text-sm text-gray-700 hover:border-gray-600 hover:text-gray-900 dark:border-white/20 dark:bg-transparent dark:text-white dark:hover:border-white/40',
                              },
                              U($(n).text),
                              9,
                              a2
  ...
  c2 = { class: 'flex w-full' },
  u2 = { class: 'min-w-0 flex-auto' },
  d2 = { class: 'px-6 pt-10 xl:px-10' },
  f2 = /* @__PURE__ */ h(
    'header',
    { id: 'header' },
    [
      ...
      /* @__PURE__ */ h(
        ...
        {
          class:
            'mt-2 text-xl font-semibold text-slate-900 dark:text-slate-400 sm:text-3xl',
        },
        ' Page Not Found '
      ),
    ],
  ...
  p2 = {
    class:
      'prose-headings:font-display prose prose-slate mx-auto mt-4 max-w-none prose-a:font-semibold prose-lead:text-slate-500 dark:prose-invert dark:prose-a:text-cyan-400 dark:prose-hr:border-slate-800 dark:prose-lead:text-slate-400',
  },
  h2 = /* @__PURE__ */ h(
    'p',
    null,
    " This page doesn't exist or has been removed. Perhaps not included in the docs yet? ",
    -1
  ),
  m2 = /* @__PURE__ */ h(
    'a',
  ...
  v2 = /* @__PURE__ */ h(
    'p',
    null,
    'Here are some links that may be what you are looking for:',
    -1
  ),
  g2 = ['href'],
  rr = /* @__PURE__ */ D({
    ...
    setup(e) {
      ...
      return (
        console.log(t.path),
        se(() => {
          n.value.push(`https://v7.docs.nativescript.org${t.path}`),
            n.value.push(`https://v6.docs.nativescript.org${t.path}`),
            n.value.push('https://v7.docs.nativescript.org'),
            n.value.push('https://v6.docs.nativescript.org')
        }),
        (r, o) => (
          _(),
          w('div', l2, [
  ...
  y2 = { class: 'mx-auto lg:px-6 2xl:container' },
  b2 = { class: 'flex' },
  w2 = { class: 'hidden lg:relative lg:block lg:flex-none' },
  x2 = /* @__PURE__ */ h(
    'div',
  ...
  O2 = /* @__PURE__ */ h(
    ...
    {
      class:
        'absolute top-12 bottom-0 right-0 hidden h-12 w-px bg-gradient-to-t from-slate-800 dark:block',
    },
    null,
    -1
  ),
  S2 = /* @__PURE__ */ h(
    ...
    {
      class:
        'absolute top-24 bottom-0 right-0 hidden w-px bg-slate-800 dark:block',
    },
    null,
    -1
  ),
  k2 = {
    class:
      'h-sidebar sticky top-[72px] overflow-y-auto overflow-x-hidden overscroll-contain',
  },
  $2 = { class: 'w-64 pt-4 pr-4 pb-10 xl:w-72' },
  P2 = { class: 'flex items-center' },
  E2 = /* @__PURE__ */ D({
    __name: 'Layout',
    setup(e) {
      const { theme: t } = De(),
...
const C2 = { class: 'mt-10 mb-16' },
  j2 = { class: 'border-b border-gray-200 dark:border-white/5' },
  T2 = { class: 'z-10 -mb-px flex' },
  A2 = ['onClick'],
  I2 = /* @__PURE__ */ D({
    __name: 'FlavorTabs',
    setup(e) {
      const { value: t, set: n } = As(),
        ...
        a = () => {
          ...
          i.value &&
            ((r.value = []),
            Array.from(i.value.children).map((u, c) => {
            ...
            (o.value =
              (l = r.value.find((u) => u.title === t.value)) != null
                ? l
                : r.value[0]))
        }
      se(() => {
        ...
        $e(t, () => {
          var u
          const l =
            (u = r.value.find((c) => c.title.toLowerCase() === t.value)) != null
              ? u
              : r.value[0]
          o.value = l
        })
      function s(l, u) {
        const c = l.target,
          p = Math.round(c.getBoundingClientRect().top)
        ;(o.value = u),
          n(u.title.toLowerCase()),
          or(() => {
            yl.scrollTo(c, 0, {
              offset: -p,
              force: !0,
      ...
      return (l, u) => (
        ...
        w('div', C2, [
                  ...
                  (c) => (
                    ...
                    w(
                      'button',
                      {
                        key: c.index,
                        class: Z([
                          'whitespace-nowrap border-b-2 px-4 py-3 text-sm font-medium uppercase focus:outline-none',
                          {
                            'border-ns-blue text-ns-blue focus:border-ns-blue dark:border-cyan-300 dark:text-cyan-300 dark:focus:border-cyan-300':
                              o.value === c,
                            'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 focus:border-gray-300 dark:text-white/90':
                              o.value !== c,
                          },
                        ]),
          ...
          h(
            ...
            {
              class:
                'tab-container relative -mt-px rounded-md rounded-t-none border px-4 shadow-lg dark:border-transparent dark:shadow-cyan-300/5',
  ...
  L2 = {
    class:
      'z-10 flex rounded-t-md border border-white/10 bg-gray-900 dark:bg-transparent',
  },
  M2 = ['onClick'],
  R2 = /* @__PURE__ */ D({
    __name: 'CodeTabs',
    setup(e) {
      const t = T(0),
        ...
        o = () => {
          n.value &&
            ((r.value = []),
            Array.from(n.value.children).map((i, a) => {
              a !== t.value && i.classList.add('hidden'),
                r.value.push({
      ...
      return (
        ...
        $e(t, (i, a) => {
          var s, l
          ;(s = n.value) == null || s.children[a].classList.add('hidden'),
            (l = n.value) == null || l.children[i].classList.remove('hidden')
        }),
        (i, a) => (
          _(),
          w('div', D2, [
                    ...
                    (s) => (
                      ...
                      w(
                        'button',
                        {
                          key: s.index,
                          class: Z([
                            'whitespace-nowrap border-b px-6 py-3 text-sm font-medium focus:outline-none',
                            {
                              'border-cyan-300 text-cyan-200 focus:border-cyan-300':
                                t.value === s.index,
...
const B2 = { class: 'flex flex-col' },
  ...
  F2 = /* @__PURE__ */ h(
    'div',
    { class: 'h-5 w-20 rounded-full ring-1 ring-ns-blue dark:ring-cyan-700' },
    null,
    -1
  ),
  z2 = /* @__PURE__ */ h(
    'div',
    {
      class: 'ml-4 h-5 w-5 rounded-full ring-1 ring-ns-blue dark:ring-cyan-700',
    },
    null,
    -1
  ),
  ...
  q2 = /* @__PURE__ */ h(
    ...
    {
      class:
        'flex h-5 w-5 items-center justify-center rounded-full ring-1 ring-ns-blue dark:ring-cyan-700',
    },
    [
      /* @__PURE__ */ h('span', {
        class: 'absolute h-0.5 w-0.5 rounded-full bg-ns-blue dark:bg-white',
      }),
    ],
    -1
  ),
    ...
    setup(e) {
      return (t, n) => (
        ...
        w(
          ...
          {
            class: Z([
              'device not-prose mr-6 inline-flex rounded-[36px] p-4 ring-1 ring-ns-blue dark:ring-cyan-700',
              {
          ...
          [
            h('div', B2, [
              ...
              h(
                ...
                {
                  class: Z([
                    'relative mt-4 overflow-hidden ring-1 ring-ns-blue dark:ring-cyan-700',
                    {
        ...
        w('div', G2, [
          h(
            'a',
            {
              ...
              target: '_blank',
              class:
                'inline-flex items-center rounded-lg bg-blue-500 px-4 py-2 font-semibold text-white hover:bg-blue-400 dark:bg-cyan-500 dark:text-slate-900 dark:hover:bg-cyan-400',
            },
            [Ae(U(e.text) + ' ', 1), Y2],
            8,
            Q2
      ...
      /* @__PURE__ */ h(
        ...
        [
          ...
          /* @__PURE__ */ h('g', { 'clip-path': 'url(#_clip1)' }, [
            ...
            /* @__PURE__ */ h(
              'g',
              { transform: 'matrix(1,0,0,1,843,512.135)' },
              [
                /* @__PURE__ */ h(
                  'g',
                  {
...
const Ct = /* @__PURE__ */ Bt(X2, [['render', rv]]),
  ov = { class: 'not-prose -mx-4 grid grid-cols-4 gap-4' },
  iv = ['href'],
  av = { class: 'ml-4' },
  sv = /* @__PURE__ */ h(
    'div',
            ...
            X(t, (o) =>
              h(
                'a',
                {
                  ...
                  target: 'blank',
                  class:
                    'flex items-center rounded-md px-4 py-2 hover:bg-black/5 dark:hover:bg-white/5',
                },
                [
                  h('div', null, [
                    (_(), ce(hn(o.icon), { class: 'h-10 w-10' })),
                  ]),
                  h('div', av, [sv, h('div', lv, U(o.name), 1)]),
                ],
                8,
                iv
              )
  ...
  yv = ['href'],
  bv = { class: 'text-right text-sm text-slate-500' },
  wv = { key: 0 },
  xv = ['href'],
  Ov = ['href'],
  Sv = {
    key: 0,
    class:
      'prose prose-slate flex min-w-full items-center dark:prose-invert sm:pl-0',
  },
  kv = /* @__PURE__ */ h(
    'svg',
    {
  ...
  Ev = /* @__PURE__ */ D({
    ...
    setup(e) {
      const t = e,
        ...
        r = A(() => {
          var s
          return (s = n == null ? void 0 : n.reflections) == null
            ? void 0
            : s[Number(t.for)]
        })
      function o(s) {
        ...
        return (
          s.line &&
            ((l += ':' + s.line), s.character && (l += ':' + s.character)),
          l
        )
      }
      function i(s) {
      ...
      function a(s) {
        if (!!s) return new URL('https://localhost' + s).hash
      }
      return (s, l) => {
        var p, f
        const u = xe('APIRefComment'),
          c = xe('APIRefParameters')
        return (
          _(),
          w(
            F,
            ...
            [
              ...
              h('div', pv, [
                ...
                w(
                  F,
                  null,
                  X((f = $(r)) == null ? void 0 : f.signatures, (d) => {
                    var v, g
                    return (
                      _(),
                      w('div', hv, [
                            ...
                            ? (_(),
                              w(
                                'a',
                                {
                                  ...
                                  href: a(d.url),
                                  class:
                                    'not-prose absolute inset-y-0 -left-6 flex items-center',
                                },
                                null,
                                8,
                                vv
                            ...
                            ? (_(),
                              w(
                                'pre',
                                {
                                  ...
                                  innerHTML: d.code,
                                  class:
                                    'mt-4 mb-0 [&_a]:text-blue-400 [&_a]:no-underline',
                                },
                                null,
                                8,
                                gv
                        ...
                        h(
                          'div',
                          {
                            class: Z([
                              'pt-2',
                              {
                                'rouded-b-md bg-slate-50 px-4 pb-4':
                                  ((g =
                                    (v = $(r)) == null
                                      ? void 0
                                      : v.signatures) == null
...
const Tv = () => {},
  Av = Object.assign,
  Iv = Array.isArray,
  Dv = (e) => typeof e == 'function',
  Nv = (e) => typeof e == 'symbol'
let Lv
function Mv(e, t = Lv) {
...
function Ca(e, t) {
  let n = !1
  Qt <= po ? wl(e) || ((e.n |= ut), (n = !bl(e))) : (n = !e.has(Ee)),
    n &&
      (e.add(Ee),
      Ee.deps.push(e),
      process.env.NODE_ENV !== 'production' &&
        Ee.onTrack &&
        Ee.onTrack(Object.assign({ effect: Ee }, t)))
}
function ja(e, t) {
  const n = Iv(e) ? e : [...e]
  for (const r of n) r.computed && Ta(r, t)
  for (const r of n) r.computed || Ta(r, t)
}
function Ta(e, t) {
  ;(e !== Ee || e.allowRecurse) &&
...
class Vv {
  constructor(t, n, r, o) {
    ;(this._setter = n),
      ...
      (this[xl] = !1),
      (this._dirty = !0),
      (this.effect = new Hv(t, () => {
        this._dirty || ((this._dirty = !0), zv(this))
      })),
...
const qv = { class: 'flex items-start' },
  Wv = { class: 'columns-1 gap-8 sm:columns-2 md:columns-3 lg:columns-4' },
  Kv = ['href'],
  Jv = {
    key: 1,
                                ...
                                ? (_(),
                                  w(
                                    'a',
                                    {
                                      ...
                                      href: a.link,
                                      class:
                                        'block text-blue-500 no-underline hover:text-blue-600 dark:text-cyan-400 dark:hover:text-cyan-600',
                                    },
                                    U(a.text),
                                    9,
                                    Kv
                                  ))
                                : (_(), w('span', Jv, U(a.text), 1)),
                            ],
                            64
                          )
                        )
  ...
  Yv = /* @__PURE__ */ D({
    ...
    setup(e) {
      const t = e,
        ...
        r = A(() => {
          var o
          return (o = n == null ? void 0 : n.hierarchy) != null
            ? o
            : t.hierarchy
        })
      return (o, i) => (
  ...
  Xv = { class: 'not-prose mt-4' },
  eg = { class: '-mx-4 overflow-x-auto sm:mx-0' },
  tg = { class: 'inline-block min-w-full' },
  ng = {
    class:
      'w- w-full min-w-[540px] border-b border-slate-200 text-left dark:border-slate-700 sm:min-w-full',
  },
  rg = { class: 'divide-y divide-slate-200 dark:divide-slate-700' },
  og = /* @__PURE__ */ h(
    'tr',
    { class: 'w-1/4 text-slate-900 dark:text-slate-400' },
    [
      /* @__PURE__ */ h(
        'td',
        {
          class:
            'w-1/6 whitespace-nowrap py-2 pl-4 text-sm font-medium sm:pl-0',
        },
        ' Parameter '
      ),
      /* @__PURE__ */ h(
        'td',
        { class: 'w-1/6 whitespace-nowrap py-2 text-sm font-medium' },
        ' Default '
      ),
      /* @__PURE__ */ h(
        'td',
        { class: 'w-2/3 whitespace-nowrap py-2 text-sm font-medium' },
        ' Description '
      ),
    ],
    -1
  ...
  ag = {
    class:
      'prose-sm prose prose-slate py-3 pl-4 align-baseline dark:prose-invert sm:pl-0',
  },
  sg = ['innerHTML'],
  lg = {
    class: 'prose-sm prose prose-slate py-3 align-baseline dark:prose-invert',
  },
  cg = { class: '' },
  ug = { class: 'py-3 align-baseline' },
  dg = {
    class:
      'prose-sm prose prose-slate my-0 space-x-5 whitespace-nowrap dark:prose-invert [&_a]:text-blue-500 dark:[&_a]:text-cyan-400',
  },
  fg = ['innerHTML'],
  pg = { class: 'prose-sm prose prose-slate dark:prose-invert' },
  hg = /* @__PURE__ */ D({
    ...
    setup(e) {
      return (t, n) => {
        ...
        return (o = e.parameters) != null && o.length
          ? (_(),
            w('div', Zv, [
              h('div', Xv, [
                h('div', eg, [
  ...
  { createElementVNode: mg, openBlock: vg, createElementBlock: gg } = Ye
var _g = function (t, n) {
  return (
    vg(),
    gg(
...
const { createElementVNode: yg, openBlock: bg, createElementBlock: wg } = Ye
var xg = function (t, n) {
    return (
      bg(),
      wg(
...
const Sg = { key: 0 },
  kg = { key: 0 },
  $g = { class: 'columns-1 gap-4 sm:columns-2 2xl:columns-3' },
  Pg = ['href'],
  Eg = ['innerHTML'],
  Cg = {
    class:
      '-mx-4 mt-4 rounded-lg border border-slate-200 dark:border-slate-700',
  },
  jg = ['onClick'],
  Tg = { class: 'ml-2' },
  Ag = ['href', 'innerHTML'],
  Ig = ['innerHTML'],
  Dg = { class: 'flex-1 text-right text-xs' },
  Ng = { class: 'columns-1 p-4 sm:columns-2 2xl:columns-3' },
  Lg = ['href'],
  Mg = ['innerHTML'],
  Rg = /* @__PURE__ */ D({
      ...
      const t = he('API_DATA'),
        n = A(
          () => (c) =>
            c.items
              .map((p) => {
                var f
                return (f = t == null ? void 0 : t.reflections) == null
                  ? void 0
                  : f[p]
              })
              .filter(Boolean)
        ...
        r = A(
          () => (c) =>
            n
              .value(c)
              .filter((p) => p.type === 'Constructor' || !p.inheritedFrom)
        ),
        o = A(
          () => (c) =>
            Object.values(
        ...
        i = A(() => (c) => {
          ...
          return (d = p == null ? void 0 : p.inheritedFrom) == null
            ? void 0
            : d.url
        }),
                                      ...
                                      w('dd', null, [
                                        h(
                                          'a',
                                          {
                                            href: d.url,
                                            class:
                                              'flex items-center text-blue-500 no-underline hover:text-blue-600 dark:text-cyan-400 dark:hover:text-cyan-600',
                                          },
                                          [
                                            B($(Aa), {
                                              class:
                                          ...
                                          w('div', null, [
                                            h(
                                              'div',
                                              {
                                                ...
                                                class:
                                                  'flex cursor-pointer items-center border-b px-4 py-2 text-slate-700 dark:text-slate-400',
                                              },
                                              [
                                                B(
                                                  $(Og),
                                                  ...
                                                  ? (_(),
                                                    w(
                                                      'a',
                                                      {
                                                        key: 0,
                                                        class:
                                                          'ml-1 text-blue-500 no-underline hover:underline',
                                                        href: d.url,
                                                        innerHTML: d.name,
                                                      },
                                                      null,
  ...
  Vg = (e) => ({
    ...
    enhanceApp(t) {
      ...
      n.component('FlavorTabs', I2),
        n.component('CodeTabs', R2),
        n.component('NotFound', rr),
        n.component('DeviceFrame', K2),
        n.component('Heading', J2),
        n.component('ExternalButtonLink', Z2),
        n.component('StackBlitzLinks', cv),
        n.component('APIRef', Ev),
        n.component('APIRefComment', jv),
        n.component('APIRefHierarchy', Yv),
        n.component('APIRefParameters', hg),
        n.component('APIRefSummary', Rg),
        n.provide('useRouter', Cl),
        n.provide('useRoute', pn),
        n.provide(Ts, tf()),
        n.use(du, {
          instantMove: !0,
          distance: 10,
