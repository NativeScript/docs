...
Apple is moving all iOS apps to the UIScene lifecycle and will require it in an upcoming release. Adopting scenes now makes your app future-proof and unlocks multiple windows on iPadOS and visionOS.
:::
...
- **"UIScene lifecycle will soon be required" in Xcode** — add the scene manifest to `Info.plist`.
