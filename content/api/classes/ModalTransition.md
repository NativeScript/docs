...
Defined in: [ui/transition/modal-transition.d.ts:2](https://github.com/NativeScript/NativeScript/blob/9.0.20-core/packages/core/ui/transition/modal-transition.d.ts#L2)
...
```ts
new ModalTransition(duration?: number, nativeCurve?: any): ModalTransition;
```
